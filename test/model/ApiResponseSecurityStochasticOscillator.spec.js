...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityStochasticOscillator();
  });
  ...
  describe('ApiResponseSecurityStochasticOscillator', function() {
    it('should create an instance of ApiResponseSecurityStochasticOscillator', function() {
      // uncomment below and update the code to test ApiResponseSecurityStochasticOscillator
      //var instane = new intrinioSDK.ApiResponseSecurityStochasticOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityStochasticOscillator);
    });
