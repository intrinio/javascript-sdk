...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.StockMarketIndexSummary();
  });
  ...
  describe('StockMarketIndexSummary', function() {
    it('should create an instance of StockMarketIndexSummary', function() {
      // uncomment below and update the code to test StockMarketIndexSummary
      //var instane = new intrinioSDK.StockMarketIndexSummary();
      //expect(instance).to.be.a(intrinioSDK.StockMarketIndexSummary);
    });
