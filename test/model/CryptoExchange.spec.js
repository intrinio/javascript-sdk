...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.CryptoExchange();
  });
  ...
  describe('CryptoExchange', function() {
    it('should create an instance of CryptoExchange', function() {
      // uncomment below and update the code to test CryptoExchange
      //var instane = new intrinioSDK.CryptoExchange();
      //expect(instance).to.be.a(intrinioSDK.CryptoExchange);
    });
