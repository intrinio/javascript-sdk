...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityIchimokuKinkoHyo();
  });
  ...
  describe('ApiResponseSecurityIchimokuKinkoHyo', function() {
    it('should create an instance of ApiResponseSecurityIchimokuKinkoHyo', function() {
      // uncomment below and update the code to test ApiResponseSecurityIchimokuKinkoHyo
      //var instane = new intrinioSDK.ApiResponseSecurityIchimokuKinkoHyo();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityIchimokuKinkoHyo);
    });
