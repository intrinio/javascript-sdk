...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseOptionPrices();
  });
  ...
  describe('ApiResponseOptionPrices', function() {
    it('should create an instance of ApiResponseOptionPrices', function() {
      // uncomment below and update the code to test ApiResponseOptionPrices
      //var instane = new intrinioSDK.ApiResponseOptionPrices();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseOptionPrices);
    });
