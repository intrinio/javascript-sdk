...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionSyntheticGreeksRealtime();
  });
  ...
  describe('OptionSyntheticGreeksRealtime', function() {
    it('should create an instance of OptionSyntheticGreeksRealtime', function() {
      // uncomment below and update the code to test OptionSyntheticGreeksRealtime
      //var instane = new intrinioSDK.OptionSyntheticGreeksRealtime();
      //expect(instance).to.be.a(intrinioSDK.OptionSyntheticGreeksRealtime);
    });
    ...
    it('should have the property syntheticPrice (base name: "synthetic_price")', function() {
      // uncomment below and update the code to test the property syntheticPrice
      //var instane = new intrinioSDK.OptionSyntheticGreeksRealtime();
      //expect(instance).to.be();
    });
