...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityVolumeWeightedAveragePrice();
  });
  ...
  describe('ApiResponseSecurityVolumeWeightedAveragePrice', function() {
    it('should create an instance of ApiResponseSecurityVolumeWeightedAveragePrice', function() {
      // uncomment below and update the code to test ApiResponseSecurityVolumeWeightedAveragePrice
      //var instane = new intrinioSDK.ApiResponseSecurityVolumeWeightedAveragePrice();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityVolumeWeightedAveragePrice);
    });
