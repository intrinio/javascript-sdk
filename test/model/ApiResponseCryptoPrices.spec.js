...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoPrices();
  });
  ...
  describe('ApiResponseCryptoPrices', function() {
    it('should create an instance of ApiResponseCryptoPrices', function() {
      // uncomment below and update the code to test ApiResponseCryptoPrices
      //var instane = new intrinioSDK.ApiResponseCryptoPrices();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoPrices);
    });
