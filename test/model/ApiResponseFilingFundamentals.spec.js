...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseFilingFundamentals();
  });
  ...
  describe('ApiResponseFilingFundamentals', function() {
    it('should create an instance of ApiResponseFilingFundamentals', function() {
      // uncomment below and update the code to test ApiResponseFilingFundamentals
      //var instane = new intrinioSDK.ApiResponseFilingFundamentals();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseFilingFundamentals);
    });
