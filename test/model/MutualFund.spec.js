...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinio.MutualFund();
  });
  ...
  describe('MutualFund', function() {
    it('should create an instance of MutualFund', function() {
      // uncomment below and update the code to test MutualFund
      //var instane = new intrinio.MutualFund();
      //expect(instance).to.be.a(intrinio.MutualFund);
    });
