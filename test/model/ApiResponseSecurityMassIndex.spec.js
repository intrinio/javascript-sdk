...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityMassIndex();
  });
  ...
  describe('ApiResponseSecurityMassIndex', function() {
    it('should create an instance of ApiResponseSecurityMassIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityMassIndex
      //var instane = new intrinioSDK.ApiResponseSecurityMassIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityMassIndex);
    });
