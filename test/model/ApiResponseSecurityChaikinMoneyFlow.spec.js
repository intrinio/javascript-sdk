...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityChaikinMoneyFlow();
  });
  ...
  describe('ApiResponseSecurityChaikinMoneyFlow', function() {
    it('should create an instance of ApiResponseSecurityChaikinMoneyFlow', function() {
      // uncomment below and update the code to test ApiResponseSecurityChaikinMoneyFlow
      //var instane = new intrinioSDK.ApiResponseSecurityChaikinMoneyFlow();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityChaikinMoneyFlow);
    });
