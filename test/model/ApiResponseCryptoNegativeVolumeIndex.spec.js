...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoNegativeVolumeIndex();
  });
  ...
  describe('ApiResponseCryptoNegativeVolumeIndex', function() {
    it('should create an instance of ApiResponseCryptoNegativeVolumeIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoNegativeVolumeIndex
      //var instane = new intrinioSDK.ApiResponseCryptoNegativeVolumeIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoNegativeVolumeIndex);
    });
