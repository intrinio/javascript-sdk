...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityKnowSureThing();
  });
  ...
  describe('ApiResponseSecurityKnowSureThing', function() {
    it('should create an instance of ApiResponseSecurityKnowSureThing', function() {
      // uncomment below and update the code to test ApiResponseSecurityKnowSureThing
      //var instane = new intrinioSDK.ApiResponseSecurityKnowSureThing();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityKnowSureThing);
    });
