...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityUltimateOscillator();
  });
  ...
  describe('ApiResponseSecurityUltimateOscillator', function() {
    it('should create an instance of ApiResponseSecurityUltimateOscillator', function() {
      // uncomment below and update the code to test ApiResponseSecurityUltimateOscillator
      //var instane = new intrinioSDK.ApiResponseSecurityUltimateOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityUltimateOscillator);
    });
