...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseStockExchanges();
  });
  ...
  describe('ApiResponseStockExchanges', function() {
    it('should create an instance of ApiResponseStockExchanges', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseStockExchanges();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseStockExchanges);
    });
