...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseOptionsSurface();
  });
  ...
  describe('ApiResponseOptionsSurface', function() {
    it('should create an instance of ApiResponseOptionsSurface', function() {
      // uncomment below and update the code to test ApiResponseOptionsSurface
      //var instane = new intrinioSDK.ApiResponseOptionsSurface();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseOptionsSurface);
    });
