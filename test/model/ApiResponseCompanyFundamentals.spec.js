...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCompanyFundamentals();
  });
  ...
  describe('ApiResponseCompanyFundamentals', function() {
    it('should create an instance of ApiResponseCompanyFundamentals', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseCompanyFundamentals();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCompanyFundamentals);
    });
