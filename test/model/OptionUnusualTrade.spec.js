...
(function(root, factory) {
  ...
  describe('OptionUnusualTrade', function() {
    ...
    it('should have the property contractExpiration (base name: "contract_expiration")', function() {
      // uncomment below and update the code to test the property contractExpiration
      //var instane = new intrinioSDK.OptionUnusualTrade();
      //expect(instance).to.be();
    });

    it('should have the property contractStrike (base name: "contract_strike")', function() {
      // uncomment below and update the code to test the property contractStrike
      //var instane = new intrinioSDK.OptionUnusualTrade();
      //expect(instance).to.be();
    });
