...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoEaseOfMovement();
  });
  ...
  describe('ApiResponseCryptoEaseOfMovement', function() {
    it('should create an instance of ApiResponseCryptoEaseOfMovement', function() {
      // uncomment below and update the code to test ApiResponseCryptoEaseOfMovement
      //var instane = new intrinioSDK.ApiResponseCryptoEaseOfMovement();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoEaseOfMovement);
    });
