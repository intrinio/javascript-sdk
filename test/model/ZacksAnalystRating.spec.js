...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ZacksAnalystRating();
  });
  ...
  describe('ZacksAnalystRating', function() {
    it('should create an instance of ZacksAnalystRating', function() {
      // uncomment below and update the code to test ZacksAnalystRating
      //var instane = new intrinioSDK.ZacksAnalystRating();
      //expect(instance).to.be.a(intrinioSDK.ZacksAnalystRating);
    });
