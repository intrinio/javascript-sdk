...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityAverageDailyTradingVolume();
  });
  ...
  describe('ApiResponseSecurityAverageDailyTradingVolume', function() {
    it('should create an instance of ApiResponseSecurityAverageDailyTradingVolume', function() {
      // uncomment below and update the code to test ApiResponseSecurityAverageDailyTradingVolume
      //var instane = new intrinioSDK.ApiResponseSecurityAverageDailyTradingVolume();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityAverageDailyTradingVolume);
    });
