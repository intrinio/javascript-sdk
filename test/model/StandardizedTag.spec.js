...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinio.StandardizedTag();
  });
  ...
  describe('StandardizedTag', function() {
    it('should create an instance of StandardizedTag', function() {
      // uncomment below and update the code to test StandardizedTag
      //var instane = new intrinio.StandardizedTag();
      //expect(instance).to.be.a(intrinio.StandardizedTag);
    });
