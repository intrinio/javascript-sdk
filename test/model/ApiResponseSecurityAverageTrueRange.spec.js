...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityAverageTrueRange();
  });
  ...
  describe('ApiResponseSecurityAverageTrueRange', function() {
    it('should create an instance of ApiResponseSecurityAverageTrueRange', function() {
      // uncomment below and update the code to test ApiResponseSecurityAverageTrueRange
      //var instane = new intrinioSDK.ApiResponseSecurityAverageTrueRange();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityAverageTrueRange);
    });
