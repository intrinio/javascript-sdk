...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoIchimokuKinkoHyo();
  });
  ...
  describe('ApiResponseCryptoIchimokuKinkoHyo', function() {
    it('should create an instance of ApiResponseCryptoIchimokuKinkoHyo', function() {
      // uncomment below and update the code to test ApiResponseCryptoIchimokuKinkoHyo
      //var instane = new intrinioSDK.ApiResponseCryptoIchimokuKinkoHyo();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoIchimokuKinkoHyo);
    });
