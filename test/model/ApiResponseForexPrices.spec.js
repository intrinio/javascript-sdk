...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseForexPrices();
  });
  ...
  describe('ApiResponseForexPrices', function() {
    it('should create an instance of ApiResponseForexPrices', function() {
      // uncomment below and update the code to test ApiResponseForexPrices
      //var instane = new intrinioSDK.ApiResponseForexPrices();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseForexPrices);
    });
