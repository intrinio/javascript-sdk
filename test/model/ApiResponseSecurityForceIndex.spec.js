...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityForceIndex();
  });
  ...
  describe('ApiResponseSecurityForceIndex', function() {
    it('should create an instance of ApiResponseSecurityForceIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityForceIndex
      //var instane = new intrinioSDK.ApiResponseSecurityForceIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityForceIndex);
    });
