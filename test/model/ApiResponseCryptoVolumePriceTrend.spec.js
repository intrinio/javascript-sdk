...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoVolumePriceTrend();
  });
  ...
  describe('ApiResponseCryptoVolumePriceTrend', function() {
    it('should create an instance of ApiResponseCryptoVolumePriceTrend', function() {
      // uncomment below and update the code to test ApiResponseCryptoVolumePriceTrend
      //var instane = new intrinioSDK.ApiResponseCryptoVolumePriceTrend();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoVolumePriceTrend);
    });
