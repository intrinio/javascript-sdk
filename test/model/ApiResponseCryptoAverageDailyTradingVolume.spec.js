...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoAverageDailyTradingVolume();
  });
  ...
  describe('ApiResponseCryptoAverageDailyTradingVolume', function() {
    it('should create an instance of ApiResponseCryptoAverageDailyTradingVolume', function() {
      // uncomment below and update the code to test ApiResponseCryptoAverageDailyTradingVolume
      //var instane = new intrinioSDK.ApiResponseCryptoAverageDailyTradingVolume();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoAverageDailyTradingVolume);
    });
