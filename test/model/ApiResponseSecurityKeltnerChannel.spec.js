...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityKeltnerChannel();
  });
  ...
  describe('ApiResponseSecurityKeltnerChannel', function() {
    it('should create an instance of ApiResponseSecurityKeltnerChannel', function() {
      // uncomment below and update the code to test ApiResponseSecurityKeltnerChannel
      //var instane = new intrinioSDK.ApiResponseSecurityKeltnerChannel();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityKeltnerChannel);
    });
