...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecuritySimpleMovingAverage();
  });
  ...
  describe('ApiResponseSecuritySimpleMovingAverage', function() {
    it('should create an instance of ApiResponseSecuritySimpleMovingAverage', function() {
      // uncomment below and update the code to test ApiResponseSecuritySimpleMovingAverage
      //var instane = new intrinioSDK.ApiResponseSecuritySimpleMovingAverage();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecuritySimpleMovingAverage);
    });
