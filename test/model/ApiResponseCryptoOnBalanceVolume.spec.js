...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoOnBalanceVolume();
  });
  ...
  describe('ApiResponseCryptoOnBalanceVolume', function() {
    it('should create an instance of ApiResponseCryptoOnBalanceVolume', function() {
      // uncomment below and update the code to test ApiResponseCryptoOnBalanceVolume
      //var instane = new intrinioSDK.ApiResponseCryptoOnBalanceVolume();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoOnBalanceVolume);
    });
