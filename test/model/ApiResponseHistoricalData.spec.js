...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseHistoricalData();
  });
  ...
  describe('ApiResponseHistoricalData', function() {
    it('should create an instance of ApiResponseHistoricalData', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseHistoricalData();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseHistoricalData);
    });
