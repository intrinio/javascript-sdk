...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoKeltnerChannel();
  });
  ...
  describe('ApiResponseCryptoKeltnerChannel', function() {
    it('should create an instance of ApiResponseCryptoKeltnerChannel', function() {
      // uncomment below and update the code to test ApiResponseCryptoKeltnerChannel
      //var instane = new intrinioSDK.ApiResponseCryptoKeltnerChannel();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoKeltnerChannel);
    });
