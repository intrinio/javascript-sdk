...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionIntervalMover();
  });
  ...
  describe('OptionIntervalMover', function() {
    it('should create an instance of OptionIntervalMover', function() {
      // uncomment below and update the code to test OptionIntervalMover
      //var instane = new intrinioSDK.OptionIntervalMover();
      //expect(instance).to.be.a(intrinioSDK.OptionIntervalMover);
    });
