...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoStochasticOscillator();
  });
  ...
  describe('ApiResponseCryptoStochasticOscillator', function() {
    it('should create an instance of ApiResponseCryptoStochasticOscillator', function() {
      // uncomment below and update the code to test ApiResponseCryptoStochasticOscillator
      //var instane = new intrinioSDK.ApiResponseCryptoStochasticOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoStochasticOscillator);
    });
