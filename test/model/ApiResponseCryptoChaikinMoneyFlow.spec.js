...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoChaikinMoneyFlow();
  });
  ...
  describe('ApiResponseCryptoChaikinMoneyFlow', function() {
    it('should create an instance of ApiResponseCryptoChaikinMoneyFlow', function() {
      // uncomment below and update the code to test ApiResponseCryptoChaikinMoneyFlow
      //var instane = new intrinioSDK.ApiResponseCryptoChaikinMoneyFlow();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoChaikinMoneyFlow);
    });
