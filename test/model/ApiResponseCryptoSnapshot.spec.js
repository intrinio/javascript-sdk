...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoSnapshot();
  });
  ...
  describe('ApiResponseCryptoSnapshot', function() {
    it('should create an instance of ApiResponseCryptoSnapshot', function() {
      // uncomment below and update the code to test ApiResponseCryptoSnapshot
      //var instane = new intrinioSDK.ApiResponseCryptoSnapshot();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoSnapshot);
    });
