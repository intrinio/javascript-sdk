...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityDetrendedPriceOscillator();
  });
  ...
  describe('ApiResponseSecurityDetrendedPriceOscillator', function() {
    it('should create an instance of ApiResponseSecurityDetrendedPriceOscillator', function() {
      // uncomment below and update the code to test ApiResponseSecurityDetrendedPriceOscillator
      //var instane = new intrinioSDK.ApiResponseSecurityDetrendedPriceOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityDetrendedPriceOscillator);
    });
