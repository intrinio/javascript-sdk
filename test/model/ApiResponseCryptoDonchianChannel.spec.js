...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoDonchianChannel();
  });
  ...
  describe('ApiResponseCryptoDonchianChannel', function() {
    it('should create an instance of ApiResponseCryptoDonchianChannel', function() {
      // uncomment below and update the code to test ApiResponseCryptoDonchianChannel
      //var instane = new intrinioSDK.ApiResponseCryptoDonchianChannel();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoDonchianChannel);
    });
