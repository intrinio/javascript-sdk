...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoDetrendedPriceOscillator();
  });
  ...
  describe('ApiResponseCryptoDetrendedPriceOscillator', function() {
    it('should create an instance of ApiResponseCryptoDetrendedPriceOscillator', function() {
      // uncomment below and update the code to test ApiResponseCryptoDetrendedPriceOscillator
      //var instane = new intrinioSDK.ApiResponseCryptoDetrendedPriceOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoDetrendedPriceOscillator);
    });
