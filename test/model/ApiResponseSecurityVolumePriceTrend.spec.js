...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityVolumePriceTrend();
  });
  ...
  describe('ApiResponseSecurityVolumePriceTrend', function() {
    it('should create an instance of ApiResponseSecurityVolumePriceTrend', function() {
      // uncomment below and update the code to test ApiResponseSecurityVolumePriceTrend
      //var instane = new intrinioSDK.ApiResponseSecurityVolumePriceTrend();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityVolumePriceTrend);
    });
