...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.FilingNoteFiling();
  });
  ...
  describe('FilingNoteFiling', function() {
    it('should create an instance of FilingNoteFiling', function() {
      // uncomment below and update the code to test FilingNoteFiling
      //var instane = new intrinioSDK.FilingNoteFiling();
      //expect(instance).to.be.a(intrinioSDK.FilingNoteFiling);
    });
