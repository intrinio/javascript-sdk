...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityTripleExponentialAverage();
  });
  ...
  describe('ApiResponseSecurityTripleExponentialAverage', function() {
    it('should create an instance of ApiResponseSecurityTripleExponentialAverage', function() {
      // uncomment below and update the code to test ApiResponseSecurityTripleExponentialAverage
      //var instane = new intrinioSDK.ApiResponseSecurityTripleExponentialAverage();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityTripleExponentialAverage);
    });
