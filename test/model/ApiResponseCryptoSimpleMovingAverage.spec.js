...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoSimpleMovingAverage();
  });
  ...
  describe('ApiResponseCryptoSimpleMovingAverage', function() {
    it('should create an instance of ApiResponseCryptoSimpleMovingAverage', function() {
      // uncomment below and update the code to test ApiResponseCryptoSimpleMovingAverage
      //var instane = new intrinioSDK.ApiResponseCryptoSimpleMovingAverage();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoSimpleMovingAverage);
    });
