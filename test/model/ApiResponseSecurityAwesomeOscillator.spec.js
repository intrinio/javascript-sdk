...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityAwesomeOscillator();
  });
  ...
  describe('ApiResponseSecurityAwesomeOscillator', function() {
    it('should create an instance of ApiResponseSecurityAwesomeOscillator', function() {
      // uncomment below and update the code to test ApiResponseSecurityAwesomeOscillator
      //var instane = new intrinioSDK.ApiResponseSecurityAwesomeOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityAwesomeOscillator);
    });
