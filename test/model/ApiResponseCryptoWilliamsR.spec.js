...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoWilliamsR();
  });
  ...
  describe('ApiResponseCryptoWilliamsR', function() {
    it('should create an instance of ApiResponseCryptoWilliamsR', function() {
      // uncomment below and update the code to test ApiResponseCryptoWilliamsR
      //var instane = new intrinioSDK.ApiResponseCryptoWilliamsR();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoWilliamsR);
    });
