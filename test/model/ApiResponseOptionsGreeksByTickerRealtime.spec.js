...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseOptionsGreeksByTickerRealtime();
  });
  ...
  describe('ApiResponseOptionsGreeksByTickerRealtime', function() {
    it('should create an instance of ApiResponseOptionsGreeksByTickerRealtime', function() {
      // uncomment below and update the code to test ApiResponseOptionsGreeksByTickerRealtime
      //var instane = new intrinioSDK.ApiResponseOptionsGreeksByTickerRealtime();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseOptionsGreeksByTickerRealtime);
    });
