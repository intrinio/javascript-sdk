...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoAwesomeOscillator();
  });
  ...
  describe('ApiResponseCryptoAwesomeOscillator', function() {
    it('should create an instance of ApiResponseCryptoAwesomeOscillator', function() {
      // uncomment below and update the code to test ApiResponseCryptoAwesomeOscillator
      //var instane = new intrinioSDK.ApiResponseCryptoAwesomeOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoAwesomeOscillator);
    });
