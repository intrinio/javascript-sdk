...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.CryptoPrice();
  });
  ...
  describe('CryptoPrice', function() {
    it('should create an instance of CryptoPrice', function() {
      // uncomment below and update the code to test CryptoPrice
      //var instane = new intrinioSDK.CryptoPrice();
      //expect(instance).to.be.a(intrinioSDK.CryptoPrice);
    });
