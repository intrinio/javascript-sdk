...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionInterval();
  });
  ...
  describe('OptionInterval', function() {
    it('should create an instance of OptionInterval', function() {
      // uncomment below and update the code to test OptionInterval
      //var instane = new intrinioSDK.OptionInterval();
      //expect(instance).to.be.a(intrinioSDK.OptionInterval);
    });
