...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoForceIndex();
  });
  ...
  describe('ApiResponseCryptoForceIndex', function() {
    it('should create an instance of ApiResponseCryptoForceIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoForceIndex
      //var instane = new intrinioSDK.ApiResponseCryptoForceIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoForceIndex);
    });
