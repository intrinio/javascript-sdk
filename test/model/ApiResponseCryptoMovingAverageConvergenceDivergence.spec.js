...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoMovingAverageConvergenceDivergence();
  });
  ...
  describe('ApiResponseCryptoMovingAverageConvergenceDivergence', function() {
    it('should create an instance of ApiResponseCryptoMovingAverageConvergenceDivergence', function() {
      // uncomment below and update the code to test ApiResponseCryptoMovingAverageConvergenceDivergence
      //var instane = new intrinioSDK.ApiResponseCryptoMovingAverageConvergenceDivergence();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoMovingAverageConvergenceDivergence);
    });
