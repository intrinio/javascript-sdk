...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityAverageDirectionalIndex();
  });
  ...
  describe('ApiResponseSecurityAverageDirectionalIndex', function() {
    it('should create an instance of ApiResponseSecurityAverageDirectionalIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityAverageDirectionalIndex
      //var instane = new intrinioSDK.ApiResponseSecurityAverageDirectionalIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityAverageDirectionalIndex);
    });
