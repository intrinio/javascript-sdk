...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoBollingerBands();
  });
  ...
  describe('ApiResponseCryptoBollingerBands', function() {
    it('should create an instance of ApiResponseCryptoBollingerBands', function() {
      // uncomment below and update the code to test ApiResponseCryptoBollingerBands
      //var instane = new intrinioSDK.ApiResponseCryptoBollingerBands();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoBollingerBands);
    });
