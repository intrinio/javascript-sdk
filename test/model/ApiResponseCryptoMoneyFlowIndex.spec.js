...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoMoneyFlowIndex();
  });
  ...
  describe('ApiResponseCryptoMoneyFlowIndex', function() {
    it('should create an instance of ApiResponseCryptoMoneyFlowIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoMoneyFlowIndex
      //var instane = new intrinioSDK.ApiResponseCryptoMoneyFlowIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoMoneyFlowIndex);
    });
