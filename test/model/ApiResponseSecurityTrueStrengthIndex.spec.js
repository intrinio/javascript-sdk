...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityTrueStrengthIndex();
  });
  ...
  describe('ApiResponseSecurityTrueStrengthIndex', function() {
    it('should create an instance of ApiResponseSecurityTrueStrengthIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityTrueStrengthIndex
      //var instane = new intrinioSDK.ApiResponseSecurityTrueStrengthIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityTrueStrengthIndex);
    });
