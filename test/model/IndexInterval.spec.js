...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.IndexInterval();
  });
  ...
  describe('IndexInterval', function() {
    it('should create an instance of IndexInterval', function() {
      // uncomment below and update the code to test IndexInterval
      //var instane = new intrinioSDK.IndexInterval();
      //expect(instance).to.be.a(intrinioSDK.IndexInterval);
    });
