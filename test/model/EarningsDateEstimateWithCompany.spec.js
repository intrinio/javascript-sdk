...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.EarningsDateEstimateWithCompany();
  });
  ...
  describe('EarningsDateEstimateWithCompany', function() {
    it('should create an instance of EarningsDateEstimateWithCompany', function() {
      // uncomment below and update the code to test EarningsDateEstimateWithCompany
      //var instane = new intrinioSDK.EarningsDateEstimateWithCompany();
      //expect(instance).to.be.a(intrinioSDK.EarningsDateEstimateWithCompany);
    });
