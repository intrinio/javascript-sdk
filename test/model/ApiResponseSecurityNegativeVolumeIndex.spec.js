...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityNegativeVolumeIndex();
  });
  ...
  describe('ApiResponseSecurityNegativeVolumeIndex', function() {
    it('should create an instance of ApiResponseSecurityNegativeVolumeIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityNegativeVolumeIndex
      //var instane = new intrinioSDK.ApiResponseSecurityNegativeVolumeIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityNegativeVolumeIndex);
    });
