...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoCommodityChannelIndex();
  });
  ...
  describe('ApiResponseCryptoCommodityChannelIndex', function() {
    it('should create an instance of ApiResponseCryptoCommodityChannelIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoCommodityChannelIndex
      //var instane = new intrinioSDK.ApiResponseCryptoCommodityChannelIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoCommodityChannelIndex);
    });
