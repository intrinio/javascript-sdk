...
(function(root, factory) {
  ...
  describe('RealtimeStockPrice', function() {
    ...
    it('should have the property bidTime (base name: "bid_time")', function() {
      // uncomment below and update the code to test the property bidTime
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property askTime (base name: "ask_time")', function() {
      // uncomment below and update the code to test the property askTime
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property eodClosePrice (base name: "eod_close_price")', function() {
      // uncomment below and update the code to test the property eodClosePrice
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property eodCloseDate (base name: "eod_close_date")', function() {
      // uncomment below and update the code to test the property eodCloseDate
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property normalMarketHoursLastTime (base name: "normal_market_hours_last_time")', function() {
      // uncomment below and update the code to test the property normalMarketHoursLastTime
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property normalMarketHoursLastPrice (base name: "normal_market_hours_last_price")', function() {
      // uncomment below and update the code to test the property normalMarketHoursLastPrice
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property normalMarketHoursLastSize (base name: "normal_market_hours_last_size")', function() {
      // uncomment below and update the code to test the property normalMarketHoursLastSize
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property qualifiedLastPrice (base name: "qualified_last_price")', function() {
      // uncomment below and update the code to test the property qualifiedLastPrice
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property qualifiedLastTime (base name: "qualified_last_time")', function() {
      // uncomment below and update the code to test the property qualifiedLastTime
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });

    it('should have the property qualifiedLastSize (base name: "qualified_last_size")', function() {
      // uncomment below and update the code to test the property qualifiedLastSize
      //var instane = new intrinioSDK.RealtimeStockPrice();
      //expect(instance).to.be();
    });
