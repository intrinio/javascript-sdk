...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityVortexIndicator();
  });
  ...
  describe('ApiResponseSecurityVortexIndicator', function() {
    it('should create an instance of ApiResponseSecurityVortexIndicator', function() {
      // uncomment below and update the code to test ApiResponseSecurityVortexIndicator
      //var instane = new intrinioSDK.ApiResponseSecurityVortexIndicator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityVortexIndicator);
    });
