...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ETFHistoricalStats();
  });
  ...
  describe('ETFHistoricalStats', function() {
    it('should create an instance of ETFHistoricalStats', function() {
      // uncomment below and update the code to test ETFHistoricalStats
      //var instane = new intrinioSDK.ETFHistoricalStats();
      //expect(instance).to.be.a(intrinioSDK.ETFHistoricalStats);
    });
