...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSICIndexHistoricalData();
  });
  ...
  describe('ApiResponseSICIndexHistoricalData', function() {
    it('should create an instance of ApiResponseSICIndexHistoricalData', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseSICIndexHistoricalData();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSICIndexHistoricalData);
    });
