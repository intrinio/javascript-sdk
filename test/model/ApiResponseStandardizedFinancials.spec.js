...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseStandardizedFinancials();
  });
  ...
  describe('ApiResponseStandardizedFinancials', function() {
    it('should create an instance of ApiResponseStandardizedFinancials', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseStandardizedFinancials();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseStandardizedFinancials);
    });
