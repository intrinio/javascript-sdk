...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseReportedFinancials();
  });
  ...
  describe('ApiResponseReportedFinancials', function() {
    it('should create an instance of ApiResponseReportedFinancials', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseReportedFinancials();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseReportedFinancials);
    });
