...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoAccumulationDistributionIndex();
  });
  ...
  describe('ApiResponseCryptoAccumulationDistributionIndex', function() {
    it('should create an instance of ApiResponseCryptoAccumulationDistributionIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoAccumulationDistributionIndex
      //var instane = new intrinioSDK.ApiResponseCryptoAccumulationDistributionIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoAccumulationDistributionIndex);
    });
