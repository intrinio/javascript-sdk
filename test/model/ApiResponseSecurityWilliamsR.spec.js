...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityWilliamsR();
  });
  ...
  describe('ApiResponseSecurityWilliamsR', function() {
    it('should create an instance of ApiResponseSecurityWilliamsR', function() {
      // uncomment below and update the code to test ApiResponseSecurityWilliamsR
      //var instane = new intrinioSDK.ApiResponseSecurityWilliamsR();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityWilliamsR);
    });
