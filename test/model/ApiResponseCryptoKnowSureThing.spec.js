...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoKnowSureThing();
  });
  ...
  describe('ApiResponseCryptoKnowSureThing', function() {
    it('should create an instance of ApiResponseCryptoKnowSureThing', function() {
      // uncomment below and update the code to test ApiResponseCryptoKnowSureThing
      //var instane = new intrinioSDK.ApiResponseCryptoKnowSureThing();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoKnowSureThing);
    });
