...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoTrueStrengthIndex();
  });
  ...
  describe('ApiResponseCryptoTrueStrengthIndex', function() {
    it('should create an instance of ApiResponseCryptoTrueStrengthIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoTrueStrengthIndex
      //var instane = new intrinioSDK.ApiResponseCryptoTrueStrengthIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoTrueStrengthIndex);
    });
