...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoVortexIndicator();
  });
  ...
  describe('ApiResponseCryptoVortexIndicator', function() {
    it('should create an instance of ApiResponseCryptoVortexIndicator', function() {
      // uncomment below and update the code to test ApiResponseCryptoVortexIndicator
      //var instane = new intrinioSDK.ApiResponseCryptoVortexIndicator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoVortexIndicator);
    });
