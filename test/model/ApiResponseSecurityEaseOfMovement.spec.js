...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityEaseOfMovement();
  });
  ...
  describe('ApiResponseSecurityEaseOfMovement', function() {
    it('should create an instance of ApiResponseSecurityEaseOfMovement', function() {
      // uncomment below and update the code to test ApiResponseSecurityEaseOfMovement
      //var instane = new intrinioSDK.ApiResponseSecurityEaseOfMovement();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityEaseOfMovement);
    });
