...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.EodIndexPriceSummary();
  });
  ...
  describe('EodIndexPriceSummary', function() {
    it('should create an instance of EodIndexPriceSummary', function() {
      // uncomment below and update the code to test EodIndexPriceSummary
      //var instane = new intrinioSDK.EodIndexPriceSummary();
      //expect(instance).to.be.a(intrinioSDK.EodIndexPriceSummary);
    });
