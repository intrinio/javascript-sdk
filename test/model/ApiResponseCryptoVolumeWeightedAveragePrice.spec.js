...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoVolumeWeightedAveragePrice();
  });
  ...
  describe('ApiResponseCryptoVolumeWeightedAveragePrice', function() {
    it('should create an instance of ApiResponseCryptoVolumeWeightedAveragePrice', function() {
      // uncomment below and update the code to test ApiResponseCryptoVolumeWeightedAveragePrice
      //var instane = new intrinioSDK.ApiResponseCryptoVolumeWeightedAveragePrice();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoVolumeWeightedAveragePrice);
    });
