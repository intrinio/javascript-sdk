...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityRelativeStrengthIndex();
  });
  ...
  describe('ApiResponseSecurityRelativeStrengthIndex', function() {
    it('should create an instance of ApiResponseSecurityRelativeStrengthIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityRelativeStrengthIndex
      //var instane = new intrinioSDK.ApiResponseSecurityRelativeStrengthIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityRelativeStrengthIndex);
    });
