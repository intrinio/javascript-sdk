...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoOnBalanceVolumeMean();
  });
  ...
  describe('ApiResponseCryptoOnBalanceVolumeMean', function() {
    it('should create an instance of ApiResponseCryptoOnBalanceVolumeMean', function() {
      // uncomment below and update the code to test ApiResponseCryptoOnBalanceVolumeMean
      //var instane = new intrinioSDK.ApiResponseCryptoOnBalanceVolumeMean();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoOnBalanceVolumeMean);
    });
