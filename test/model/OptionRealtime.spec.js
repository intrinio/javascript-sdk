...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionRealtime();
  });
  ...
  describe('OptionRealtime', function() {
    it('should create an instance of OptionRealtime', function() {
      // uncomment below and update the code to test OptionRealtime
      //var instane = new intrinioSDK.OptionRealtime();
      //expect(instance).to.be.a(intrinioSDK.OptionRealtime);
    });
