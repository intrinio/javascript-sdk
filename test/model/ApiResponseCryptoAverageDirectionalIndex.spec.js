...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoAverageDirectionalIndex();
  });
  ...
  describe('ApiResponseCryptoAverageDirectionalIndex', function() {
    it('should create an instance of ApiResponseCryptoAverageDirectionalIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoAverageDirectionalIndex
      //var instane = new intrinioSDK.ApiResponseCryptoAverageDirectionalIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoAverageDirectionalIndex);
    });
