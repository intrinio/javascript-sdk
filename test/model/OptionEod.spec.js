...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionEod();
  });
  ...
  describe('OptionEod', function() {
    it('should create an instance of OptionEod', function() {
      // uncomment below and update the code to test OptionEod
      //var instane = new intrinioSDK.OptionEod();
      //expect(instance).to.be.a(intrinioSDK.OptionEod);
    });
