...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoUltimateOscillator();
  });
  ...
  describe('ApiResponseCryptoUltimateOscillator', function() {
    it('should create an instance of ApiResponseCryptoUltimateOscillator', function() {
      // uncomment below and update the code to test ApiResponseCryptoUltimateOscillator
      //var instane = new intrinioSDK.ApiResponseCryptoUltimateOscillator();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoUltimateOscillator);
    });
