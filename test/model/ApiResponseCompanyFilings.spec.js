...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCompanyFilings();
  });
  ...
  describe('ApiResponseCompanyFilings', function() {
    it('should create an instance of ApiResponseCompanyFilings', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseCompanyFilings();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCompanyFilings);
    });
