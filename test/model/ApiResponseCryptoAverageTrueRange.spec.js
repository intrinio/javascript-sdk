...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoAverageTrueRange();
  });
  ...
  describe('ApiResponseCryptoAverageTrueRange', function() {
    it('should create an instance of ApiResponseCryptoAverageTrueRange', function() {
      // uncomment below and update the code to test ApiResponseCryptoAverageTrueRange
      //var instane = new intrinioSDK.ApiResponseCryptoAverageTrueRange();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoAverageTrueRange);
    });
