...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.SecurityIntervalsMoversResult();
  });
  ...
  describe('SecurityIntervalsMoversResult', function() {
    it('should create an instance of SecurityIntervalsMoversResult', function() {
      // uncomment below and update the code to test SecurityIntervalsMoversResult
      //var instane = new intrinioSDK.SecurityIntervalsMoversResult();
      //expect(instance).to.be.a(intrinioSDK.SecurityIntervalsMoversResult);
    });
