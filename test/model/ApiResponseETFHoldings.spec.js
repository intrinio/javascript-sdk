...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseETFHoldings();
  });
  ...
  describe('ApiResponseETFHoldings', function() {
    it('should create an instance of ApiResponseETFHoldings', function() {
      // uncomment below and update the code to test ApiResponseETFHoldings
      //var instane = new intrinioSDK.ApiResponseETFHoldings();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseETFHoldings);
    });
