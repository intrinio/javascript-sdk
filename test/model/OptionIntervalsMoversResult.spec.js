...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionIntervalsMoversResult();
  });
  ...
  describe('OptionIntervalsMoversResult', function() {
    it('should create an instance of OptionIntervalsMoversResult', function() {
      // uncomment below and update the code to test OptionIntervalsMoversResult
      //var instane = new intrinioSDK.OptionIntervalsMoversResult();
      //expect(instance).to.be.a(intrinioSDK.OptionIntervalsMoversResult);
    });
