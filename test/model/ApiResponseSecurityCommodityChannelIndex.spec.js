...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityCommodityChannelIndex();
  });
  ...
  describe('ApiResponseSecurityCommodityChannelIndex', function() {
    it('should create an instance of ApiResponseSecurityCommodityChannelIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityCommodityChannelIndex
      //var instane = new intrinioSDK.ApiResponseSecurityCommodityChannelIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityCommodityChannelIndex);
    });
