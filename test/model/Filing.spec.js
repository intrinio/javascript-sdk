...
(function(root, factory) {
  ...
  describe('Filing', function() {
    ...
    it('should have the property earningsDisclosed8kId (base name: "earnings_disclosed_8k_id")', function() {
      // uncomment below and update the code to test the property earningsDisclosed8kId
      //var instane = new intrinioSDK.Filing();
      //expect(instance).to.be();
    });

    it('should have the property earnings8kUrl (base name: "earnings_8k_url")', function() {
      // uncomment below and update the code to test the property earnings8kUrl
      //var instane = new intrinioSDK.Filing();
      //expect(instance).to.be();
    });
