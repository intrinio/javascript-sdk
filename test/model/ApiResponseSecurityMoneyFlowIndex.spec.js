...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityMoneyFlowIndex();
  });
  ...
  describe('ApiResponseSecurityMoneyFlowIndex', function() {
    it('should create an instance of ApiResponseSecurityMoneyFlowIndex', function() {
      // uncomment below and update the code to test ApiResponseSecurityMoneyFlowIndex
      //var instane = new intrinioSDK.ApiResponseSecurityMoneyFlowIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityMoneyFlowIndex);
    });
