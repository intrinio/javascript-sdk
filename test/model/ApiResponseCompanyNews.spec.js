...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCompanyNews();
  });
  ...
  describe('ApiResponseCompanyNews', function() {
    it('should create an instance of ApiResponseCompanyNews', function() {
      ...
      //var instane = new intrinioSDK.ApiResponseCompanyNews();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCompanyNews);
    });
