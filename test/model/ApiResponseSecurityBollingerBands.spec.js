...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityBollingerBands();
  });
  ...
  describe('ApiResponseSecurityBollingerBands', function() {
    it('should create an instance of ApiResponseSecurityBollingerBands', function() {
      // uncomment below and update the code to test ApiResponseSecurityBollingerBands
      //var instane = new intrinioSDK.ApiResponseSecurityBollingerBands();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityBollingerBands);
    });
