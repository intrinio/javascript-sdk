...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoRelativeStrengthIndex();
  });
  ...
  describe('ApiResponseCryptoRelativeStrengthIndex', function() {
    it('should create an instance of ApiResponseCryptoRelativeStrengthIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoRelativeStrengthIndex
      //var instane = new intrinioSDK.ApiResponseCryptoRelativeStrengthIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoRelativeStrengthIndex);
    });
