...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ZacksEPSSurpriseSummary();
  });
  ...
  describe('ZacksEPSSurpriseSummary', function() {
    it('should create an instance of ZacksEPSSurpriseSummary', function() {
      // uncomment below and update the code to test ZacksEPSSurpriseSummary
      //var instane = new intrinioSDK.ZacksEPSSurpriseSummary();
      //expect(instance).to.be.a(intrinioSDK.ZacksEPSSurpriseSummary);
    });
