...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoMassIndex();
  });
  ...
  describe('ApiResponseCryptoMassIndex', function() {
    it('should create an instance of ApiResponseCryptoMassIndex', function() {
      // uncomment below and update the code to test ApiResponseCryptoMassIndex
      //var instane = new intrinioSDK.ApiResponseCryptoMassIndex();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoMassIndex);
    });
