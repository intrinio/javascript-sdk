...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.EodIndexPrice();
  });
  ...
  describe('EodIndexPrice', function() {
    it('should create an instance of EodIndexPrice', function() {
      // uncomment below and update the code to test EodIndexPrice
      //var instane = new intrinioSDK.EodIndexPrice();
      //expect(instance).to.be.a(intrinioSDK.EodIndexPrice);
    });
