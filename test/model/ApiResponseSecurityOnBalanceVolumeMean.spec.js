...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityOnBalanceVolumeMean();
  });
  ...
  describe('ApiResponseSecurityOnBalanceVolumeMean', function() {
    it('should create an instance of ApiResponseSecurityOnBalanceVolumeMean', function() {
      // uncomment below and update the code to test ApiResponseSecurityOnBalanceVolumeMean
      //var instane = new intrinioSDK.ApiResponseSecurityOnBalanceVolumeMean();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityOnBalanceVolumeMean);
    });
