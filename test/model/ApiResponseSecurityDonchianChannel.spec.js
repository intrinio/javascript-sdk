...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityDonchianChannel();
  });
  ...
  describe('ApiResponseSecurityDonchianChannel', function() {
    it('should create an instance of ApiResponseSecurityDonchianChannel', function() {
      // uncomment below and update the code to test ApiResponseSecurityDonchianChannel
      //var instane = new intrinioSDK.ApiResponseSecurityDonchianChannel();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityDonchianChannel);
    });
