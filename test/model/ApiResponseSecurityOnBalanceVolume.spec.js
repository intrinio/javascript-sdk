...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseSecurityOnBalanceVolume();
  });
  ...
  describe('ApiResponseSecurityOnBalanceVolume', function() {
    it('should create an instance of ApiResponseSecurityOnBalanceVolume', function() {
      // uncomment below and update the code to test ApiResponseSecurityOnBalanceVolume
      //var instane = new intrinioSDK.ApiResponseSecurityOnBalanceVolume();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseSecurityOnBalanceVolume);
    });
