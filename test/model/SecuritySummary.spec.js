...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.SecuritySummary();
  });
  ...
  describe('SecuritySummary', function() {
    it('should create an instance of SecuritySummary', function() {
      ...
      //var instane = new intrinioSDK.SecuritySummary();
      //expect(instance).to.be.a(intrinioSDK.SecuritySummary);
    });
    ...
    it('should have the property stockExchangeId (base name: "stock_exchange_id")', function() {
      // uncomment below and update the code to test the property stockExchangeId
      //var instane = new intrinioSDK.SecuritySummary();
      //expect(instance).to.be();
    });
