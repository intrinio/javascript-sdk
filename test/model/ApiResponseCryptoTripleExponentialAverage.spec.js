...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ApiResponseCryptoTripleExponentialAverage();
  });
  ...
  describe('ApiResponseCryptoTripleExponentialAverage', function() {
    it('should create an instance of ApiResponseCryptoTripleExponentialAverage', function() {
      // uncomment below and update the code to test ApiResponseCryptoTripleExponentialAverage
      //var instane = new intrinioSDK.ApiResponseCryptoTripleExponentialAverage();
      //expect(instance).to.be.a(intrinioSDK.ApiResponseCryptoTripleExponentialAverage);
    });
