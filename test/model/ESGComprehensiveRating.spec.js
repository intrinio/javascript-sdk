...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.ESGComprehensiveRating();
  });
  ...
  describe('ESGComprehensiveRating', function() {
    it('should create an instance of ESGComprehensiveRating', function() {
      // uncomment below and update the code to test ESGComprehensiveRating
      //var instane = new intrinioSDK.ESGComprehensiveRating();
      //expect(instance).to.be.a(intrinioSDK.ESGComprehensiveRating);
    });
