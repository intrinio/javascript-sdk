...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intrinioSDK.OptionMover();
  });
  ...
  describe('OptionMover', function() {
    it('should create an instance of OptionMover', function() {
      // uncomment below and update the code to test OptionMover
      //var instane = new intrinioSDK.OptionMover();
      //expect(instance).to.be.a(intrinioSDK.OptionMover);
    });
