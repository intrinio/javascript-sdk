...
(function(root, factory) {
  ...
  describe('CompanyApi', function() {
    describe('allExpectedEarningsDates', function() {
      it('should call allExpectedEarningsDates successfully', function(done) {
        //uncomment below and update the code to test allExpectedEarningsDates
        //instance.allExpectedEarningsDates(function(error) {
    ...
    describe('expectedEarningsDatesByCompany', function() {
      it('should call expectedEarningsDatesByCompany successfully', function(done) {
        //uncomment below and update the code to test expectedEarningsDatesByCompany
        //instance.expectedEarningsDatesByCompany(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
