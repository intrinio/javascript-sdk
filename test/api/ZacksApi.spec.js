...
(function(root, factory) {
  ...
  describe('ZacksApi', function() {
    ...
    describe('getZacksEbitdaConsensus', function() {
      it('should call getZacksEbitdaConsensus successfully', function(done) {
        //uncomment below and update the code to test getZacksEbitdaConsensus
        //instance.getZacksEbitdaConsensus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getZacksForwardPe', function() {
      it('should call getZacksForwardPe successfully', function(done) {
        //uncomment below and update the code to test getZacksForwardPe
        //instance.getZacksForwardPe(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getZacksForwardPeByIdentifier', function() {
      it('should call getZacksForwardPeByIdentifier successfully', function(done) {
        //uncomment below and update the code to test getZacksForwardPeByIdentifier
        //instance.getZacksForwardPeByIdentifier(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getZacksSalesEstimates', function() {
      it('should call getZacksSalesEstimates successfully', function(done) {
        //uncomment below and update the code to test getZacksSalesEstimates
        //instance.getZacksSalesEstimates(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
