...
(function(root, factory) {
  ...
  describe('FilingApi', function() {
    ...
    describe('getFilingAnswers', function() {
      it('should call getFilingAnswers successfully', function(done) {
        //uncomment below and update the code to test getFilingAnswers
        //instance.getFilingAnswers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
