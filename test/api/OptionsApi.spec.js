...
(function(root, factory) {
  ...
  describe('OptionsApi', function() {
    ...
    describe('optionsGreeksByTickerIdentifierRealtimeGet', function() {
      it('should call optionsGreeksByTickerIdentifierRealtimeGet successfully', function(done) {
        //uncomment below and update the code to test optionsGreeksByTickerIdentifierRealtimeGet
        //instance.optionsGreeksByTickerIdentifierRealtimeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('optionsGreeksContractRealtimeGet', function() {
      it('should call optionsGreeksContractRealtimeGet successfully', function(done) {
        //uncomment below and update the code to test optionsGreeksContractRealtimeGet
        //instance.optionsGreeksContractRealtimeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
