...
(function(root, factory) {
  ...
  describe('ETFsApi', function() {
    ...
    describe('getEtfHistoricalNavFlows', function() {
      it('should call getEtfHistoricalNavFlows successfully', function(done) {
        //uncomment below and update the code to test getEtfHistoricalNavFlows
        //instance.getEtfHistoricalNavFlows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEtfHistoricalStats', function() {
      it('should call getEtfHistoricalStats successfully', function(done) {
        //uncomment below and update the code to test getEtfHistoricalStats
        //instance.getEtfHistoricalStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEtfNavFlows', function() {
      it('should call getEtfNavFlows successfully', function(done) {
        //uncomment below and update the code to test getEtfNavFlows
        //instance.getEtfNavFlows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEtfsNavFlows', function() {
      it('should call getEtfsNavFlows successfully', function(done) {
        //uncomment below and update the code to test getEtfsNavFlows
        //instance.getEtfsNavFlows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
