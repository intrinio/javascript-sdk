...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseZacksAnalystRatings', 'model/ApiResponseZacksEBITDAConsensus', 'model/ApiResponseZacksEPSEstimates', 'model/ApiResponseZacksEPSGrowthRates', 'model/ApiResponseZacksEPSSurprises', 'model/ApiResponseZacksETFHoldings', 'model/ApiResponseZacksForwardPEs', 'model/ApiResponseZacksInstitutionalHoldingCompanies', 'model/ApiResponseZacksInstitutionalHoldingOwners', 'model/ApiResponseZacksInstitutionalHoldings', 'model/ApiResponseZacksLongTermGrowthRates', 'model/ApiResponseZacksSalesEstimates', 'model/ApiResponseZacksSalesSurprises', 'model/ApiResponseZacksTargetPriceConsensuses', 'model/ZacksForwardPE'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseZacksAnalystRatings'), require('../model/ApiResponseZacksEBITDAConsensus'), require('../model/ApiResponseZacksEPSEstimates'), require('../model/ApiResponseZacksEPSGrowthRates'), require('../model/ApiResponseZacksEPSSurprises'), require('../model/ApiResponseZacksETFHoldings'), require('../model/ApiResponseZacksForwardPEs'), require('../model/ApiResponseZacksInstitutionalHoldingCompanies'), require('../model/ApiResponseZacksInstitutionalHoldingOwners'), require('../model/ApiResponseZacksInstitutionalHoldings'), require('../model/ApiResponseZacksLongTermGrowthRates'), require('../model/ApiResponseZacksSalesEstimates'), require('../model/ApiResponseZacksSalesSurprises'), require('../model/ApiResponseZacksTargetPriceConsensuses'), require('../model/ZacksForwardPE'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ZacksApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseZacksAnalystRatings, root.intrinioSDK.ApiResponseZacksEBITDAConsensus, root.intrinioSDK.ApiResponseZacksEPSEstimates, root.intrinioSDK.ApiResponseZacksEPSGrowthRates, root.intrinioSDK.ApiResponseZacksEPSSurprises, root.intrinioSDK.ApiResponseZacksETFHoldings, root.intrinioSDK.ApiResponseZacksForwardPEs, root.intrinioSDK.ApiResponseZacksInstitutionalHoldingCompanies, root.intrinioSDK.ApiResponseZacksInstitutionalHoldingOwners, root.intrinioSDK.ApiResponseZacksInstitutionalHoldings, root.intrinioSDK.ApiResponseZacksLongTermGrowthRates, root.intrinioSDK.ApiResponseZacksSalesEstimates, root.intrinioSDK.ApiResponseZacksSalesSurprises, root.intrinioSDK.ApiResponseZacksTargetPriceConsensuses, root.intrinioSDK.ZacksForwardPE);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.type Limit EBITDA estimates to this type
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseZacksEBITDAConsensus} and HTTP response
     */
    this.getZacksEbitdaConsensusWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseZacksEBITDAConsensus;
      var endpoint = '/zacks/ebitda_consensus'
      var method = 'GET'
     ...
     * @param {String} opts.type Limit EBITDA estimates to this type
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseZacksEBITDAConsensus}
     */
    this.getZacksEbitdaConsensus = function(opts) {
      return this.getZacksEbitdaConsensusWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseZacksForwardPEs} and HTTP response
     */
    this.getZacksForwardPeWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseZacksForwardPEs;
      var endpoint = '/zacks/forward_pe'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseZacksForwardPEs}
     */
    this.getZacksForwardPe = function(opts) {
      return this.getZacksForwardPeWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier An Intrinio ID or ticker for a Security
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ZacksForwardPE} and HTTP response
     */
    this.getZacksForwardPeByIdentifierWithHttpInfo = function(identifier) {
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getZacksForwardPeByIdentifier");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ZacksForwardPE;
      var endpoint = '/zacks/forward_pe/{identifier}'
      var method = 'GET'
     ...
     * Returns the forward PE estimates for the identifier
     * @param {String} identifier An Intrinio ID or ticker for a Security
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ZacksForwardPE}
     */
    this.getZacksForwardPeByIdentifier = function(identifier) {
      return this.getZacksForwardPeByIdentifierWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.identifier A Company identifier (Ticker, CIK, LEI, Intrinio ID)
     * @param {Date} opts.startDate Limit Sales estimates to those on or after this date
     * @param {Date} opts.endDate Limit Sales estimates to those on or before this date
     * @param {Number} opts.fiscalYear Only for the given fiscal year
     * @param {module:model/String} opts.fiscalPeriod The fiscal period
     * @param {Number} opts.calendarYear Only for the given calendar year
     * @param {module:model/String} opts.calendarPeriod The calendar period
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseZacksSalesEstimates} and HTTP response
     */
    this.getZacksSalesEstimatesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseZacksSalesEstimates;
      var endpoint = '/zacks/sales_estimates'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage2 Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseZacksSalesEstimates}
     */
    this.getZacksSalesEstimates = function(opts) {
      return this.getZacksSalesEstimatesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
