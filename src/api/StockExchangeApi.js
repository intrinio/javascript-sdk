...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseStockExchangeBetas', 'model/ApiResponseStockExchangeMovers', 'model/ApiResponseStockExchangeQuote', 'model/ApiResponseStockExchangeRealtimeStockPrices', 'model/ApiResponseStockExchangeSecurities', 'model/ApiResponseStockExchangeStockPriceAdjustments', 'model/ApiResponseStockExchangeStockPrices', 'model/ApiResponseStockExchanges', 'model/StockExchange'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseStockExchangeBetas'), require('../model/ApiResponseStockExchangeMovers'), require('../model/ApiResponseStockExchangeQuote'), require('../model/ApiResponseStockExchangeRealtimeStockPrices'), require('../model/ApiResponseStockExchangeSecurities'), require('../model/ApiResponseStockExchangeStockPriceAdjustments'), require('../model/ApiResponseStockExchangeStockPrices'), require('../model/ApiResponseStockExchanges'), require('../model/StockExchange'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.StockExchangeApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseStockExchangeBetas, root.intrinioSDK.ApiResponseStockExchangeMovers, root.intrinioSDK.ApiResponseStockExchangeQuote, root.intrinioSDK.ApiResponseStockExchangeRealtimeStockPrices, root.intrinioSDK.ApiResponseStockExchangeSecurities, root.intrinioSDK.ApiResponseStockExchangeStockPriceAdjustments, root.intrinioSDK.ApiResponseStockExchangeStockPrices, root.intrinioSDK.ApiResponseStockExchanges, root.intrinioSDK.StockExchange);
  }
}(this, function(ApiClient, ApiResponseStockExchangeBetas, ApiResponseStockExchangeMovers, ApiResponseStockExchangeQuote, ApiResponseStockExchangeRealtimeStockPrices, ApiResponseStockExchangeSecurities, ApiResponseStockExchangeStockPriceAdjustments, ApiResponseStockExchangeStockPrices, ApiResponseStockExchanges, StockExchange) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.type Only of the given type (default to weekly)
     * @param {Object} opts.date Return data for this period end date.
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeBetas} and HTTP response
     */
    this.getStockExchangeBetasWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangeBetas");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeBetas;
      var endpoint = '/stock_exchanges/{identifier}/betas'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeBetas}
     */
    this.getStockExchangeBetas = function(identifier, opts) {
      return this.getStockExchangeBetasWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier A Stock Exchange identifier (MIC or Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.minPrice The minimum price filter
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeMovers} and HTTP response
     */
    this.getStockExchangeGainersWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangeGainers");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeMovers;
      var endpoint = '/stock_exchanges/{identifier}/gainers'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeMovers}
     */
    this.getStockExchangeGainers = function(identifier, opts) {
      return this.getStockExchangeGainersWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeMovers} and HTTP response
     */
    this.getStockExchangeLosersWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangeLosers");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeMovers;
      var endpoint = '/stock_exchanges/{identifier}/losers'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeMovers}
     */
    this.getStockExchangeLosers = function(identifier, opts) {
      return this.getStockExchangeLosersWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier A Stock Exchange identifier (MIC or Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Date} opts.date The date for which to return dividends
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeStockPriceAdjustments} and HTTP response
     */
    this.getStockExchangePriceAdjustmentsDividendsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangePriceAdjustmentsDividends");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeStockPriceAdjustments;
      var endpoint = '/stock_exchanges/{identifier}/prices/adjustments/dividends'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeStockPriceAdjustments}
     */
    this.getStockExchangePriceAdjustmentsDividends = function(identifier, opts) {
      return this.getStockExchangePriceAdjustmentsDividendsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier A Stock Exchange identifier (MIC or Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Date} opts.date The date for which to return splits
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeStockPriceAdjustments} and HTTP response
     */
    this.getStockExchangePriceAdjustmentsSplitsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangePriceAdjustmentsSplits");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeStockPriceAdjustments;
      var endpoint = '/stock_exchanges/{identifier}/prices/adjustments/splits'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeStockPriceAdjustments}
     */
    this.getStockExchangePriceAdjustmentsSplits = function(identifier, opts) {
      return this.getStockExchangePriceAdjustmentsSplitsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier A Stock Exchange identifier (MIC or Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Date} opts.date The date for which to return prices. May not be used with the start_date and end_date parameters.
     * @param {Date} opts.startDate The start of the date range you&#39;re querying. May not be used with date parameter.
     ...
     * @param {String} identifier A Stock Exchange identifier (MIC or Intrinio ID)
     * @param {Array.<String>} tickers The comma-delimited list of ticker symbols to return quotes for.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @param {Boolean} opts.activeOnly Returns prices only from the most recent trading day.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseStockExchangeQuote} and HTTP response
     */
    this.getStockExchangeQuoteWithHttpInfo = function(identifier, tickers, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getStockExchangeQuote");
      }

      // verify the required parameter 'tickers' is set
      if (tickers === undefined || tickers === null) {
        throw new Error("Missing the required parameter 'tickers' when calling getStockExchangeQuote");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseStockExchangeQuote;
      var endpoint = '/stock_exchanges/{identifier}/quote'
      var method = 'GET'
     ...
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @param {Boolean} opts.activeOnly Returns prices only from the most recent trading day.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseStockExchangeQuote}
     */
    this.getStockExchangeQuote = function(identifier, tickers, opts) {
      return this.getStockExchangeQuoteWithHttpInfo(identifier, tickers, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Boolean} opts.activeOnly Returns prices only from the most recent trading day.
     * @param {Boolean} opts.tradedToday Returns prices only from securities which have traded on the most recent trading day.
     * @param {Number} opts.pageSize The number of results to return (default to 100)
