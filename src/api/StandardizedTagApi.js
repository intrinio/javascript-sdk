...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataPointNumber', 'model/DataPointText', 'model/HistoricalData', 'model/StandardizedTag'], factory);
   ...
   * @module api/StandardizedTagApi
   * @version 0.0.1
   */

  /**
   * Constructs a new StandardizedTagApi. 
   * @alias module:api/StandardizedTagApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/StandardizedTag>} and HTTP response
     */
     ...
     * @param {module:model/String} opts.fsTemplate Template (default to industrial)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/StandardizedTag>}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/StandardizedTag} and HTTP response
     */
     ...
     * Get a Standardized Tag by ID
     * @param {String} tagId The Intrinio ID for the tag
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/StandardizedTag}
     */
