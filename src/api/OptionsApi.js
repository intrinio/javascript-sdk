...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} identifier The ticker symbol for the surface data being requested.
     * @param {module:model/String} surfaceType The form of the surface being requested.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source The specific source of the data being requested.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionsSurface} and HTTP response
     */
    this.getOptionSurfaceWithHttpInfo = function(identifier, surfaceType, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getOptionSurface");
      }

      // verify the required parameter 'surfaceType' is set
      if (surfaceType === undefined || surfaceType === null) {
        throw new Error("Missing the required parameter 'surfaceType' when calling getOptionSurface");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseOptionsSurface;
      var endpoint = '/options/surface/{identifier}'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source The specific source of the data being requested.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionsSurface}
     */
    this.getOptionSurface = function(identifier, surfaceType, opts) {
      return this.getOptionSurfaceWithHttpInfo(identifier, surfaceType, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier The ticker symbol for the surface data being requested.
     * @param {Date} expiration The DateTime of the expiration for the contract to calculate implied volatility from the surface.
     * @param {Number} strike The strike for the contract to calculate implied volatility from the surface.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source The specific source of the data being requested.
     * @param {Date} opts.asOf The time to use in calculating time until expiration.  Defaults to the current time.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionsSurfaceInterpolatedIv} and HTTP response
     */
    this.getOptionSurface_0WithHttpInfo = function(identifier, expiration, strike, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getOptionSurface_0");
      }

      // verify the required parameter 'expiration' is set
      if (expiration === undefined || expiration === null) {
        throw new Error("Missing the required parameter 'expiration' when calling getOptionSurface_0");
      }

      // verify the required parameter 'strike' is set
      if (strike === undefined || strike === null) {
        throw new Error("Missing the required parameter 'strike' when calling getOptionSurface_0");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseOptionsSurfaceInterpolatedIv;
      var endpoint = '/options/surface/{identifier}/interpolate_iv'
      var method = 'GET'
     ...
     * @param {module:model/String} opts.source The specific source of the data being requested.
     * @param {Date} opts.asOf The time to use in calculating time until expiration.  Defaults to the current time.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionsSurfaceInterpolatedIv}
     */
    this.getOptionSurface_0 = function(identifier, expiration, strike, opts) {
      return this.getOptionSurface_0WithHttpInfo(identifier, expiration, strike, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Boolean} opts.includeRelatedSymbols Include related symbols that end in a 1 or 2 because of a corporate action.
     * @param {Boolean} opts.recalculateStats Recalculate implied volatility and greeks on the fly using end-of-day underlying prices. (default to false)
     * @param {module:model/String} opts.model The options pricing model to use when recalculating stats. (default to black_scholes)
     * @param {module:model/String} opts.ivMode The implied volatility calculation mode to use when recalculating stats.
    ...
    this.getOptionsChainEodWithHttpInfo = function(symbol, expiration, opts) {
      ...
      var queryParams = {
        ...
        'date': opts['date'],
        'include_related_symbols': opts['includeRelatedSymbols'],
        'recalculate_stats': opts['recalculateStats'],
        'model': opts['model'],
        'iv_mode': opts['ivMode'],
      };
      var collectionQueryParams = {
     ...
     * @param {module:model/String} mode Which metric to sort by - change, percent change, or volume.
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionMovers} and HTTP response
     */
    this.getOptionsGainersWithHttpInfo = function(mode, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
        throw new Error("Missing the required parameter 'mode' when calling getOptionsGainers");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseOptionMovers;
      var endpoint = '/options/gainers'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionMovers}
     */
    this.getOptionsGainers = function(mode, opts) {
      return this.getOptionsGainersWithHttpInfo(mode, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} symbol The ticker symbol for the contracts.
     * @param {Date} expirationDate The expiration date for the contracts to consider.
     * @param {Date} asOfDate The historical date to evaluate implied move on.
     * @param {Object} opts Optional parameters
     * @param {Object} opts.percentage Percentage to multiply the straddle by. Defaults to 0.85.
     * @param {module:model/String} opts.source Realtime or 15-minute delayed contracts used for underlying mapping.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionsImpliedMove} and HTTP response
     */
    this.getOptionsImpliedMoveHistoricalBySymbolWithHttpInfo = function(symbol, expirationDate, asOfDate, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'symbol' is set
      if (symbol === undefined || symbol === null) {
        throw new Error("Missing the required parameter 'symbol' when calling getOptionsImpliedMoveHistoricalBySymbol");
      }

      // verify the required parameter 'expirationDate' is set
      if (expirationDate === undefined || expirationDate === null) {
        throw new Error("Missing the required parameter 'expirationDate' when calling getOptionsImpliedMoveHistoricalBySymbol");
      }

      // verify the required parameter 'asOfDate' is set
      if (asOfDate === undefined || asOfDate === null) {
        throw new Error("Missing the required parameter 'asOfDate' when calling getOptionsImpliedMoveHistoricalBySymbol");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseOptionsImpliedMove;
      var endpoint = '/options/implied_move/{symbol}/{expiration_date}/historical/{as_of_date}'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionsImpliedMove}
     */
    this.getOptionsImpliedMoveHistoricalBySymbol = function(symbol, expirationDate, asOfDate, opts) {
      return this.getOptionsImpliedMoveHistoricalBySymbolWithHttpInfo(symbol, expirationDate, asOfDate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionMovers} and HTTP response
     */
    this.getOptionsLosersWithHttpInfo = function(mode, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
        throw new Error("Missing the required parameter 'mode' when calling getOptionsLosers");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionMovers}
     */
    this.getOptionsLosers = function(mode, opts) {
      return this.getOptionsLosersWithHttpInfo(mode, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
