...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.optionsGreeksByTickerIdentifierRealtimeGetWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling optionsGreeksByTickerIdentifierRealtimeGet");
      }
     ...
     */
    this.optionsGreeksByTickerIdentifierRealtimeGet = function(identifier, opts) {
      return this.optionsGreeksByTickerIdentifierRealtimeGetWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.optionsGreeksContractRealtimeGetWithHttpInfo = function(contract, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'contract' is set
      if (contract === undefined || contract === null) {
        throw new Error("Missing the required parameter 'contract' when calling optionsGreeksContractRealtimeGet");
      }
     ...
     */
    this.optionsGreeksContractRealtimeGet = function(contract, opts) {
      return this.optionsGreeksContractRealtimeGetWithHttpInfo(contract, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
