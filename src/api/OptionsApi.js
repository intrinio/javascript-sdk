...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseOptionPrices', 'model/ApiResponseOptionPricesRealtime', 'model/ApiResponseOptions', 'model/ApiResponseOptionsChain', 'model/ApiResponseOptionsChainRealtime', 'model/ApiResponseOptionsExpirations'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseOptionPrices'), require('../model/ApiResponseOptionPricesRealtime'), require('../model/ApiResponseOptions'), require('../model/ApiResponseOptionsChain'), require('../model/ApiResponseOptionsChainRealtime'), require('../model/ApiResponseOptionsExpirations'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.OptionsApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseOptionPrices, root.intrinioSDK.ApiResponseOptionPricesRealtime, root.intrinioSDK.ApiResponseOptions, root.intrinioSDK.ApiResponseOptionsChain, root.intrinioSDK.ApiResponseOptionsChainRealtime, root.intrinioSDK.ApiResponseOptionsExpirations);
  }
}(this, function(ApiClient, ApiResponseOptionPrices, ApiResponseOptionPricesRealtime, ApiResponseOptions, ApiResponseOptionsChain, ApiResponseOptionsChainRealtime, ApiResponseOptionsExpirations) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source Realtime or 15-minute delayed contracts.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseOptionPricesRealtime} and HTTP response
     */
    this.getOptionsPricesRealtimeWithHttpInfo = function(identifier, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseOptionPricesRealtime;
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.source Realtime or 15-minute delayed contracts.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseOptionPricesRealtime}
     */
    ...
    this.makeApiCall = function(parameters) {
      ...
      return retry((bail, attempt) => {
          return new Promise((resolve, reject) => {
            ...
            .catch((error) => {
              var errorNumber = Number(error.status.toString().charAt(0));
