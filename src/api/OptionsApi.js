...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseOptionPrices', 'model/ApiResponseOptions', 'model/ApiResponseOptionsChain', 'model/ApiResponseOptionsChainRealtime', 'model/ApiResponseOptionsExpirations', 'model/ApiResponseOptionsPriceRealtime', 'model/ApiResponseOptionsRealtime', 'model/ApiResponseOptionsStatsRealtime'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseOptionPrices'), require('../model/ApiResponseOptions'), require('../model/ApiResponseOptionsChain'), require('../model/ApiResponseOptionsChainRealtime'), require('../model/ApiResponseOptionsExpirations'), require('../model/ApiResponseOptionsPriceRealtime'), require('../model/ApiResponseOptionsRealtime'), require('../model/ApiResponseOptionsStatsRealtime'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.OptionsApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseOptionPrices, root.intrinioSDK.ApiResponseOptions, root.intrinioSDK.ApiResponseOptionsChain, root.intrinioSDK.ApiResponseOptionsChainRealtime, root.intrinioSDK.ApiResponseOptionsExpirations, root.intrinioSDK.ApiResponseOptionsPriceRealtime, root.intrinioSDK.ApiResponseOptionsRealtime, root.intrinioSDK.ApiResponseOptionsStatsRealtime);
  }
}(this, function(ApiClient, ApiResponseOptionPrices, ApiResponseOptions, ApiResponseOptionsChain, ApiResponseOptionsChainRealtime, ApiResponseOptionsExpirations, ApiResponseOptionsPriceRealtime, ApiResponseOptionsRealtime, ApiResponseOptionsStatsRealtime) {
  'use strict';
