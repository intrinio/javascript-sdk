...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    this.makeApiCall = function(parameters) {
      ...
      async function makeApiRequest(thing) {
        let response = thing.apiClient.callApi(
          endpoint, method,
      ...
      return retry(async (bail, attempt) => {
          return await makeApiRequest(this).then((response) => {
            return response;
          });
      }, {
        minTimeout: 1000,
    ...
    this.getDataTagByIdWithHttpInfo = function(identifier) {
      ...
      var endpoint = '/data_tags/{identifier}'
      var method = 'GET'
