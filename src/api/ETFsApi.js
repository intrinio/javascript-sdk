...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseETFHoldings', 'model/ApiResponseETFs', 'model/ETF', 'model/ETFAnalytics', 'model/ETFHistoricalStats', 'model/ETFStats'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseETFHoldings'), require('../model/ApiResponseETFs'), require('../model/ETF'), require('../model/ETFAnalytics'), require('../model/ETFHistoricalStats'), require('../model/ETFStats'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ETFsApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseETFHoldings, root.intrinioSDK.ApiResponseETFs, root.intrinioSDK.ETF, root.intrinioSDK.ETFAnalytics, root.intrinioSDK.ETFHistoricalStats, root.intrinioSDK.ETFStats);
  }
}(this, function(ApiClient, ApiResponseETFHoldings, ApiResponseETFs, ETF, ETFAnalytics, ETFHistoricalStats, ETFStats) {
  'use strict';
