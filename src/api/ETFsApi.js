...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseETFHoldings', 'model/ApiResponseETFs', 'model/ETF', 'model/ETFAnalytics', 'model/ETFHistoricalStats', 'model/ETFNavFlows', 'model/ETFNavFlowsAll', 'model/ETFNavFlowsHistorical', 'model/ETFStats'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseETFHoldings'), require('../model/ApiResponseETFs'), require('../model/ETF'), require('../model/ETFAnalytics'), require('../model/ETFHistoricalStats'), require('../model/ETFNavFlows'), require('../model/ETFNavFlowsAll'), require('../model/ETFNavFlowsHistorical'), require('../model/ETFStats'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ETFsApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseETFHoldings, root.intrinioSDK.ApiResponseETFs, root.intrinioSDK.ETF, root.intrinioSDK.ETFAnalytics, root.intrinioSDK.ETFHistoricalStats, root.intrinioSDK.ETFNavFlows, root.intrinioSDK.ETFNavFlowsAll, root.intrinioSDK.ETFNavFlowsHistorical, root.intrinioSDK.ETFStats);
  }
}(this, function(ApiClient, ApiResponseETFHoldings, ApiResponseETFs, ETF, ETFAnalytics, ETFHistoricalStats, ETFNavFlows, ETFNavFlowsAll, ETFNavFlowsHistorical, ETFStats) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} identifier An ETF identifier (Ticker, Figi Ticker, ISIN, RIC, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Date} opts.startDate Return NAV flows on or after this date
     * @param {Date} opts.endDate Return NAV flows on or before this date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ETFNavFlowsHistorical} and HTTP response
     */
    this.getEtfHistoricalNavFlowsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getEtfHistoricalNavFlows");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ETFNavFlowsHistorical;
      var endpoint = '/etfs/{identifier}/nav_flows/historical'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ETFNavFlowsHistorical}
     */
    this.getEtfHistoricalNavFlows = function(identifier, opts) {
      return this.getEtfHistoricalNavFlowsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} identifier An ETF identifier (Ticker, Figi Ticker, ISIN, RIC, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Date} opts.startDate The start date for the historical stats data in YYYY-MM-DD format.
     * @param {Date} opts.endDate The end date for the historical stats data in YYYY-MM-DD format.
     * @param {Number} opts.pageSize The maximum number of results to return per page. (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ETFHistoricalStats} and HTTP response
     */
    this.getEtfHistoricalStatsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getEtfHistoricalStats");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ETFHistoricalStats;
      var endpoint = '/etfs/{identifier}/historical_stats'
      var method = 'GET'
     ...
     * @param {Date} opts.endDate The end date for the historical stats data in YYYY-MM-DD format.
     * @param {Number} opts.pageSize The maximum number of results to return per page. (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ETFHistoricalStats}
     */
    this.getEtfHistoricalStats = function(identifier, opts) {
      return this.getEtfHistoricalStatsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ETFNavFlows} and HTTP response
     */
    this.getEtfNavFlowsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getEtfNavFlows");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ETFNavFlows;
      var endpoint = '/etfs/{identifier}/nav_flows'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ETFNavFlows}
     */
    this.getEtfNavFlows = function(identifier, opts) {
      return this.getEtfNavFlowsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.countryCode The ISO country code to filter ETFs by (e.g., US, CA, GB). Defaults to US. (default to US)
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ETFNavFlowsAll} and HTTP response
     */
    this.getEtfsNavFlowsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ETFNavFlowsAll;
      var endpoint = '/etfs/nav_flows'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ETFNavFlowsAll}
     */
    this.getEtfsNavFlows = function(opts) {
      return this.getEtfsNavFlowsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
