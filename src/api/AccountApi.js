...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseAccountUsages', 'model/ApiResponseWebsocketStatuses'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseAccountUsages'), require('../model/ApiResponseWebsocketStatuses'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.AccountApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseAccountUsages, root.intrinioSDK.ApiResponseWebsocketStatuses);
  }
}(this, function(ApiClient, ApiResponseAccountUsages, ApiResponseWebsocketStatuses) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.getAccountCurrentUsageWithHttpInfo = function() {
      ...
      var endpoint = '/account/current_usage'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseWebsocketStatuses} and HTTP response
     */
    this.getAccountWebsocketStatusesWithHttpInfo = function() {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseWebsocketStatuses;
      var endpoint = '/account/websocket_statuses'
      var method = 'GET'
     ...
     * Account Websocket Statuses
     * Returns a list of all websocket statuses for the account.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseWebsocketStatuses}
     */
    this.getAccountWebsocketStatuses = function() {
      return this.getAccountWebsocketStatusesWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
