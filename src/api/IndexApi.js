...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseEconomicIndexHistoricalData', 'model/ApiResponseEconomicIndices', 'model/ApiResponseEconomicIndicesSearch', 'model/ApiResponseEodIndexPrices', 'model/ApiResponseEodIndexPricesAll', 'model/ApiResponseIndex', 'model/ApiResponseIndices', 'model/ApiResponseRealtimeIndexPrices', 'model/ApiResponseSICIndexHistoricalData', 'model/ApiResponseSICIndices', 'model/ApiResponseSICIndicesSearch', 'model/ApiResponseStockMarketIndexHistoricalData', 'model/ApiResponseStockMarketIndices', 'model/ApiResponseStockMarketIndicesSearch', 'model/EconomicIndex', 'model/RealtimeIndexPrice', 'model/SICIndex', 'model/StockMarketIndex'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseEconomicIndexHistoricalData'), require('../model/ApiResponseEconomicIndices'), require('../model/ApiResponseEconomicIndicesSearch'), require('../model/ApiResponseEodIndexPrices'), require('../model/ApiResponseEodIndexPricesAll'), require('../model/ApiResponseIndex'), require('../model/ApiResponseIndices'), require('../model/ApiResponseRealtimeIndexPrices'), require('../model/ApiResponseSICIndexHistoricalData'), require('../model/ApiResponseSICIndices'), require('../model/ApiResponseSICIndicesSearch'), require('../model/ApiResponseStockMarketIndexHistoricalData'), require('../model/ApiResponseStockMarketIndices'), require('../model/ApiResponseStockMarketIndicesSearch'), require('../model/EconomicIndex'), require('../model/RealtimeIndexPrice'), require('../model/SICIndex'), require('../model/StockMarketIndex'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.IndexApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseEconomicIndexHistoricalData, root.intrinioSDK.ApiResponseEconomicIndices, root.intrinioSDK.ApiResponseEconomicIndicesSearch, root.intrinioSDK.ApiResponseEodIndexPrices, root.intrinioSDK.ApiResponseEodIndexPricesAll, root.intrinioSDK.ApiResponseIndex, root.intrinioSDK.ApiResponseIndices, root.intrinioSDK.ApiResponseRealtimeIndexPrices, root.intrinioSDK.ApiResponseSICIndexHistoricalData, root.intrinioSDK.ApiResponseSICIndices, root.intrinioSDK.ApiResponseSICIndicesSearch, root.intrinioSDK.ApiResponseStockMarketIndexHistoricalData, root.intrinioSDK.ApiResponseStockMarketIndices, root.intrinioSDK.ApiResponseStockMarketIndicesSearch, root.intrinioSDK.EconomicIndex, root.intrinioSDK.RealtimeIndexPrice, root.intrinioSDK.SICIndex, root.intrinioSDK.StockMarketIndex);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {Date} opts.startDate Limit prices to those on or after this date
     * @param {Date} opts.endDate Limit prices to those on or before this date
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseEodIndexPricesAll} and HTTP response
     */
    this.getAllEodIndexPricesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseEodIndexPricesAll;
      var endpoint = '/indices/prices/eod'
      var method = 'GET'
     ...
     * @param {Date} opts.startDate Limit prices to those on or after this date
     * @param {Date} opts.endDate Limit prices to those on or before this date
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseEodIndexPricesAll}
     */
    this.getAllEodIndexPrices = function(opts) {
      return this.getAllEodIndexPricesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseIndices} and HTTP response
     */
    this.getAllIndexSummariesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseIndices;
      var endpoint = '/indices'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseIndices}
     */
    this.getAllIndexSummaries = function(opts) {
      return this.getAllIndexSummariesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseRealtimeIndexPrices} and HTTP response
     */
    this.getAllRealtimeIndexPricesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseRealtimeIndexPrices;
      var endpoint = '/indices/prices/realtime'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseRealtimeIndexPrices}
     */
    this.getAllRealtimeIndexPrices = function(opts) {
      return this.getAllRealtimeIndexPricesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Date} opts.startDate Limit prices to those on or after this date
     * @param {Date} opts.endDate Limit prices to those on or before this date
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseEodIndexPrices} and HTTP response
     */
    this.getEodIndexPriceByIdWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getEodIndexPriceById");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseEodIndexPrices;
      var endpoint = '/indices/{identifier}/eod'
      var method = 'GET'
     ...
     * @param {Date} opts.startDate Limit prices to those on or after this date
     * @param {Date} opts.endDate Limit prices to those on or before this date
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseEodIndexPrices}
     */
    this.getEodIndexPriceById = function(identifier, opts) {
      return this.getEodIndexPriceByIdWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.getIndexSummaryByIdWithHttpInfo = function(identifier) {
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getIndexSummaryById");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseIndex;
      var endpoint = '/indices/{identifier}'
      var method = 'GET'
     ...
     * Index Summary By Identifier
     * @param {String} identifier The index symbol
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseIndex}
     */
    this.getIndexSummaryById = function(identifier) {
      return this.getIndexSummaryByIdWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
