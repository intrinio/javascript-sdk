...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} identifier The index symbol
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseIndexConstituents} and HTTP response
     */
    this.getIndexConstituentsByIdWithHttpInfo = function(identifier) {
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getIndexConstituentsById");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseIndexConstituents;
      var endpoint = '/indices/{identifier}/constituents'
      var method = 'GET'
     ...
     * Index Constituents By Index Identifier
     * @param {String} identifier The index symbol
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseIndexConstituents}
     */
    this.getIndexConstituentsById = function(identifier) {
      return this.getIndexConstituentsByIdWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
