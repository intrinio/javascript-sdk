...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.startTime Return intervals starting at the specified time on the &#x60;start_date&#x60; (24-hour in &#39;hh:mm&#39; format, UTC timezone)
     * @param {Date} opts.endDate Return intervals stopping at the specified date
     * @param {String} opts.endTime Return intervals stopping at the specified time on the &#x60;end_date&#x60; (24-hour in &#39;hh:mm&#39; format, UTC timezone)
     * @param {module:model/String} opts.timezone Returns trading times in this timezone (default to UTC)
     * @param {String} opts.intervalSize The interval for which to return stock prices (default to 1d)
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     */
    this.getSecurityIntervalPricesWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var queryParams = {
        ...
        'interval_size': opts['intervalSize'],
        'page_size': opts['pageSize'],
        'next_page': opts['nextPage'],
      };
      var collectionQueryParams = {
     ...
     */
    this.getSecurityIntervalPrices = function(identifier, opts) {
      return this.getSecurityIntervalPricesWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
