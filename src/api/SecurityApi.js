...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getSecurityInsiderOwnershipWithHttpInfo = function(identifier) {
      var postBody = null;
     ...
     */
    this.getSecurityInsiderOwnership = function(identifier) {
      return this.getSecurityInsiderOwnershipWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
