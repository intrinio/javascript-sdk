...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.tickers A list of one or more security tickers to filter results
     * @param {Date} opts.startDate The start date for the data (inclusive) in YYYY-MM-DD format
     * @param {Date} opts.endDate The end date for the data (inclusive) in YYYY-MM-DD format
     * @param {module:model/String} opts.sortBy Specifies how to sort the data. Valid values are \&quot;date\&quot; (default, descending) or \&quot;ticker\&quot; (ascending)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecuritiesDailyShortVolume} and HTTP response
     */
    this.getSecuritiesDailyShortVolumeWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecuritiesDailyShortVolume;
      var endpoint = '/securities/daily_short_volume'
      var method = 'GET'
     ...
     * @param {module:model/String} opts.sortBy Specifies how to sort the data. Valid values are \&quot;date\&quot; (default, descending) or \&quot;ticker\&quot; (ascending)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecuritiesDailyShortVolume}
     */
    this.getSecuritiesDailyShortVolume = function(opts) {
      return this.getSecuritiesDailyShortVolumeWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Date} opts.endDate The end date for the data (inclusive) in YYYY-MM-DD format
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecuritiesDailyShortVolumeConsolidated} and HTTP response
     */
    this.getSecuritiesDailyShortVolumeConsolidatedWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecuritiesDailyShortVolumeConsolidated;
      var endpoint = '/securities/daily_short_volume/consolidated'
      var method = 'GET'
     ...
     * @param {Date} opts.endDate The end date for the data (inclusive) in YYYY-MM-DD format
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecuritiesDailyShortVolumeConsolidated}
     */
    this.getSecuritiesDailyShortVolumeConsolidated = function(opts) {
      return this.getSecuritiesDailyShortVolumeConsolidatedWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @param {Date} opts.date Return dividend records on or before this date. Format YYYY-MM-DD
     * @param {String} opts.identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
     * @param {String} opts.nextPage2 Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecuritiesDividendLatest} and HTTP response
     */
    this.getSecuritiesLatestDividendRecordsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecuritiesDividendLatest;
      var endpoint = '/securities/dividends/latest'
      var method = 'GET'
     ...
     * @param {String} opts.identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
     * @param {String} opts.nextPage2 Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecuritiesDividendLatest}
     */
    this.getSecuritiesLatestDividendRecords = function(opts) {
      return this.getSecuritiesLatestDividendRecordsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @param {Date} opts.date Return earnings records on or before this date. Format YYYY-MM-DD
     * @param {String} opts.identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
     * @param {String} opts.nextPage2 Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecuritiesEarningsLatest} and HTTP response
     */
    this.getSecuritiesLatestEarningsRecordsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecuritiesEarningsLatest;
      var endpoint = '/securities/earnings/latest'
      var method = 'GET'
     ...
     * @param {String} opts.identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
     * @param {String} opts.nextPage2 Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecuritiesEarningsLatest}
     */
    this.getSecuritiesLatestEarningsRecords = function(opts) {
      return this.getSecuritiesLatestEarningsRecordsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecuritiesShortInterest} and HTTP response
     */
    this.getSecuritiesShortInterestWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecuritiesShortInterest;
      var endpoint = '/securities/short_interest'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecuritiesShortInterest}
     */
    this.getSecuritiesShortInterest = function(opts) {
      return this.getSecuritiesShortInterestWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Boolean} opts.includeQuoteOnlyBars If true, also include bars where no trades occurred but quotes did. (default to false)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
    ...
    this.getSecurityIntervalPricesWithHttpInfo = function(identifier, intervalSize, opts) {
      ...
      var queryParams = {
        ...
        'include_quote_only_bars': opts['includeQuoteOnlyBars'],
        'next_page': opts['nextPage'],
      };
      var collectionQueryParams = {
      };
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Average Daily Trading Volume (default to 22)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Average Directional Index (default to 14)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.shortPeriod The number of observations to calculate short period Simple Moving Average of the Awesome Oscillator (default to 5)
     * @param {Number} opts.longPeriod The number of observations to calculate long period Simple Moving Average of the Awesome Oscillator (default to 34)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Average True Range (default to 14)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Bollinger Bands (default to 20)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Commodity Channel Index (default to 20)
     * @param {Number} opts.constant The number of observations to calculate Commodity Channel Index (default to 0.015)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Chaikin Money Flow (default to 20)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Donchian Channel (default to 20)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Detrended Price Oscillator (default to 20)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Ease of Movement (default to 20)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.lowPeriod The number of observations to calculate Tenkan Sen (Conversion Line) of Ichimoku Kinko Hyo (default to 9)
     * @param {Number} opts.mediumPeriod The number of observations to calculate Kijun Sen (Base Line), Senkou Span A (Leading Span A), and Chikou Span (Lagging Span) of Ichimoku Kinko Hyo (default to 26)
     * @param {Number} opts.highPeriod The number of observations to calculate Senkou Span B (Leading Span B) of Ichimoku Kinko Hyo (default to 52)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Kelter Channel (default to 10)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.roc1 The number of observations to calculate the rate-of-change for RCMA1 (default to 10)
     * @param {Number} opts.roc2 The number of observations to calculate the rate-of-change for RCMA2 (default to 15)
     * @param {Number} opts.roc3 The number of observations to calculate the rate-of-change for RCMA3 (default to 20)
     * @param {Number} opts.roc4 The number of observations to calculate the rate-of-change for RCMA4 (default to 30)
     * @param {Number} opts.sma1 The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA1 (default to 10)
     * @param {Number} opts.sma2 The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA2 (default to 10)
     * @param {Number} opts.sma3 The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA3 (default to 10)
     * @param {Number} opts.sma4 The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA4 (default to 15)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.fastPeriod The number of observations to calculate the fast moving Exponential Moving Average for Moving Average Convergence Divergence (default to 12)
     * @param {Number} opts.slowPeriod The number of observations to calculate the slow moving Exponential Moving Average for Moving Average Convergence Divergence (default to 26)
     * @param {Number} opts.signalPeriod The number of observations to calculate the signal line for Moving Average Convergence Divergence (default to 9)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Money Flow Index (default to 14)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.emaPeriod The number of observations to calculate the single Exponential Moving Average and the Double Exponential Moving Average for Mass Index (default to 9)
     * @param {Number} opts.sumPeriod The number of observations to calculate the sum of the Exponetinal Moving Average Ratios for Mass Index (default to 25)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate On-balance Volume Mean (default to 10)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Relative Strength Index (default to 14)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Simple Moving Average (default to 20)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate %K of Stochastic Oscillator (default to 14)
     * @param {Number} opts.signalPeriod The number of observations to calculate the %D (the Simple Moving Average of %K) as a signal line for Stochastic Oscillator (default to 3)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Exponential Moving Average for Triple Exponential Average (default to 15)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.lowPeriod The number of observations to calculate low period Exponential Moving Average for smoothing in True Strength Index (default to 13)
     * @param {Number} opts.highPeriod The number of observations to calculate high period Exponential Moving Average for smoothing in True Strength Index (default to 25)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.shortPeriod The number of observations to calculate the short period for Ultimate Oscillator (default to 7)
     * @param {Number} opts.mediumPeriod The number of observations to calculate the medium period for Ultimate Oscillator (default to 14)
     * @param {Number} opts.longPeriod The number of observations to calculate the long period for Ultimate Oscillator (default to 28)
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to calculate Vortex Indicator (default to 14)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Number} opts.period The number of observations to look-back when calculating Williams %R (default to 14)
     * @param {String} opts.startDate Return technical indicator values on or after the date
     * @param {String} opts.endDate Return technical indicator values on or before the date
     * @param {Number} opts.pageSize The number of results to return (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.activeOnly Whether to return only realtime prices from today. (default to false)
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityQuote} and HTTP response
     */
    this.getSecurityQuoteWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getSecurityQuote");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityQuote;
      var endpoint = '/securities/{identifier}/quote'
      var method = 'GET'
     ...
     * @param {module:model/String} opts.source Return the realtime price from the specified source instead of the most recent.
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityQuote}
     */
    this.getSecurityQuote = function(identifier, opts) {
      return this.getSecurityQuoteWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityShortInterest} and HTTP response
     */
    this.getSecurityShortInterestWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getSecurityShortInterest");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityShortInterest;
      var endpoint = '/securities/{identifier}/short_interest'
      var method = 'GET'
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityShortInterest}
     */
    this.getSecurityShortInterest = function(identifier, opts) {
      return this.getSecurityShortInterestWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/String} opts.source Return the snapshot from the specified source.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityStockPriceAdjustments} and HTTP response
     */
    this.getSecurityStockPriceAdjustmentsDividendsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getSecurityStockPriceAdjustmentsDividends");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityStockPriceAdjustments;
      var endpoint = '/securities/{identifier}/prices/adjustments/dividends'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityStockPriceAdjustments}
     */
    this.getSecurityStockPriceAdjustmentsDividends = function(identifier, opts) {
      return this.getSecurityStockPriceAdjustmentsDividendsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityStockPriceAdjustments} and HTTP response
     */
    this.getSecurityStockPriceAdjustmentsSplitsWithHttpInfo = function(identifier, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getSecurityStockPriceAdjustmentsSplits");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityStockPriceAdjustments;
      var endpoint = '/securities/{identifier}/prices/adjustments/splits'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityStockPriceAdjustments}
     */
    this.getSecurityStockPriceAdjustmentsSplits = function(identifier, opts) {
      return this.getSecurityStockPriceAdjustmentsSplitsWithHttpInfo(identifier, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/String} source The specific source of the data being requested.  Specifying delayed sip will result in the system automatically determining which delayed sip source (cta_delayed, cta_b_delayed, utp_delayed, otc_delayed) to use.
     * @param {Object} opts Optional parameters
     * @param {Date} opts.startDate The start date for the data being requested.
     * @param {String} opts.startTime The start time for the data being requested.
     * @param {Date} opts.endDate The end date for the data being requested.
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {module:model/String} source The specific source of the data being requested.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityTradingStatus} and HTTP response
     */
    this.getSecurityTradingStatusWithHttpInfo = function(identifier, source) {
      var postBody = null;

      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getSecurityTradingStatus");
      }

      // verify the required parameter 'source' is set
      if (source === undefined || source === null) {
        throw new Error("Missing the required parameter 'source' when calling getSecurityTradingStatus");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityTradingStatus;
      var endpoint = '/securities/{identifier}/trading_status'
      var method = 'GET'
     ...
     * @param {String} identifier A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID)
     * @param {module:model/String} source The specific source of the data being requested.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityTradingStatus}
     */
    this.getSecurityTradingStatus = function(identifier, source) {
      return this.getSecurityTradingStatusWithHttpInfo(identifier, source)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} opts.pageSize The maximum number of results to return per page. (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityTradingStatuses} and HTTP response
     */
    this.getSecurityTradingStatusQuotesOnlyWithHttpInfo = function(source, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'source' is set
      if (source === undefined || source === null) {
        throw new Error("Missing the required parameter 'source' when calling getSecurityTradingStatusQuotesOnly");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityTradingStatuses;
      var endpoint = '/securities/trading_status/quotes_only'
      var method = 'GET'
     ...
     * @param {Number} opts.pageSize The maximum number of results to return per page. (default to 100)
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityTradingStatuses}
     */
    this.getSecurityTradingStatusQuotesOnly = function(source, opts) {
      return this.getSecurityTradingStatusQuotesOnlyWithHttpInfo(source, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityTradingStatuses} and HTTP response
     */
    this.getSecurityTradingStatusStoppedWithHttpInfo = function(source, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'source' is set
      if (source === undefined || source === null) {
        throw new Error("Missing the required parameter 'source' when calling getSecurityTradingStatusStopped");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityTradingStatuses;
      var endpoint = '/securities/trading_status/stopped'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityTradingStatuses}
     */
    this.getSecurityTradingStatusStopped = function(source, opts) {
      return this.getSecurityTradingStatusStoppedWithHttpInfo(source, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponseSecurityTradingStatuses} and HTTP response
     */
    this.getSecurityTradingStatusTradingWithHttpInfo = function(source, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'source' is set
      if (source === undefined || source === null) {
        throw new Error("Missing the required parameter 'source' when calling getSecurityTradingStatusTrading");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ApiResponseSecurityTradingStatuses;
      var endpoint = '/securities/trading_status/trading'
      var method = 'GET'
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponseSecurityTradingStatuses}
     */
    this.getSecurityTradingStatusTrading = function(source, opts) {
      return this.getSecurityTradingStatusTradingWithHttpInfo(source, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
