...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseESGCompanies', 'model/ApiResponseESGCompanyRatingHistory', 'model/ApiResponseESGLatest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseESGCompanies'), require('../model/ApiResponseESGCompanyRatingHistory'), require('../model/ApiResponseESGLatest'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ESGApi = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ApiResponseESGCompanies, root.intrinioSDK.ApiResponseESGCompanyRatingHistory, root.intrinioSDK.ApiResponseESGLatest);
  }
}(this, function(ApiClient, ApiResponseESGCompanies, ApiResponseESGCompanyRatingHistory, ApiResponseESGLatest) {
  'use strict';
