...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.StockMarketIndexSummary = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/StockMarketIndexSummary
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>StockMarketIndexSummary</code>.
   * @alias module:invoker/model/StockMarketIndexSummary
   * @class
   */
   ...
   * @param {module:invoker/model/StockMarketIndexSummary} obj Optional instance to populate.
   * @return {module:invoker/model/StockMarketIndexSummary} The populated <code>StockMarketIndexSummary</code> instance.
   */
