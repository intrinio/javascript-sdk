...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/SecurityScreenResultData', 'invoker/model/SecuritySummary'], factory);
   ...
   * @module invoker/model/SecurityScreenResult
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/SecurityScreenResult
   * @class
   */
   ...
   * @param {module:invoker/model/SecurityScreenResult} obj Optional instance to populate.
   * @return {module:invoker/model/SecurityScreenResult} The populated <code>SecurityScreenResult</code> instance.
   */
  ...
  /**
   * @member {Array.<module:invoker/model/SecurityScreenResultData>} data
   */
