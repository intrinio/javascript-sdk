...
(function(root, factory) {
   ...
   * @module invoker/model/DataPointText
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/DataPointText
   * @class
   */
   ...
   * @param {module:invoker/model/DataPointText} obj Optional instance to populate.
   * @return {module:invoker/model/DataPointText} The populated <code>DataPointText</code> instance.
   */
