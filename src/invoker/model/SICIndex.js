...
(function(root, factory) {
   ...
   * @alias module:invoker/model/SICIndex
   * @class
   */
   ...
   * @param {module:invoker/model/SICIndex} obj Optional instance to populate.
   * @return {module:invoker/model/SICIndex} The populated <code>SICIndex</code> instance.
   */
