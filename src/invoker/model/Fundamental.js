...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/CompanySummary'], factory);
    ...
    root.intrinio.Fundamental = factory(root.intrinio.ApiClient, root.intrinio.CompanySummary);
  }
   ...
   * @module invoker/model/Fundamental
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Fundamental</code>.
   * @alias module:invoker/model/Fundamental
   * @class
   */
   ...
   * @param {module:invoker/model/Fundamental} obj Optional instance to populate.
   * @return {module:invoker/model/Fundamental} The populated <code>Fundamental</code> instance.
   */
   ...
   * @member {module:invoker/model/CompanySummary} company
   */
   ...
   * @member {module:invoker/model/Fundamental.TypeEnum} type
   */
