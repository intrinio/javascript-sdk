...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.FilingSummary = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/FilingSummary
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/FilingSummary
   * @class
   */
   ...
   * @param {module:invoker/model/FilingSummary} obj Optional instance to populate.
   * @return {module:invoker/model/FilingSummary} The populated <code>FilingSummary</code> instance.
   */
