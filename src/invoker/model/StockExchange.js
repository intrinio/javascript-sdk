...
(function(root, factory) {
   ...
   * @module invoker/model/StockExchange
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/StockExchange
   * @class
   */
   ...
   * @param {module:invoker/model/StockExchange} obj Optional instance to populate.
   * @return {module:invoker/model/StockExchange} The populated <code>StockExchange</code> instance.
   */
