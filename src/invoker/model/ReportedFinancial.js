...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/ReportedTag'], factory);
   ...
   * @module invoker/model/ReportedFinancial
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/ReportedFinancial
   * @class
   */
   ...
   * @param {module:invoker/model/ReportedFinancial} obj Optional instance to populate.
   * @return {module:invoker/model/ReportedFinancial} The populated <code>ReportedFinancial</code> instance.
   */
  ...
  /**
   * @member {module:invoker/model/ReportedTag} xbrl_tag
   */
