...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.StockMarketIndex = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/StockMarketIndex
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>StockMarketIndex</code>.
   * @alias module:invoker/model/StockMarketIndex
   * @class
   */
   ...
   * @param {module:invoker/model/StockMarketIndex} obj Optional instance to populate.
   * @return {module:invoker/model/StockMarketIndex} The populated <code>StockMarketIndex</code> instance.
   */
