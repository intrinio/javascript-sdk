...
(function(root, factory) {
   ...
   * @module invoker/model/ReportedTag
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/ReportedTag
   * @class
   */
   ...
   * @param {module:invoker/model/ReportedTag} obj Optional instance to populate.
   * @return {module:invoker/model/ReportedTag} The populated <code>ReportedTag</code> instance.
   */
