...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/StandardizedTag'], factory);
   ...
   * @module invoker/model/StandardizedFinancial
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/StandardizedFinancial
   * @class
   */
   ...
   * @param {module:invoker/model/StandardizedFinancial} obj Optional instance to populate.
   * @return {module:invoker/model/StandardizedFinancial} The populated <code>StandardizedFinancial</code> instance.
   */
  ...
  /**
   * @member {module:invoker/model/StandardizedTag} data_tag
   */
