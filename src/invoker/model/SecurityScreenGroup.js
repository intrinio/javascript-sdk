...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/SecurityScreenClause', 'invoker/model/SecurityScreenGroup'], factory);
    ...
    root.intrinio.SecurityScreenGroup = factory(root.intrinio.ApiClient, root.intrinio.SecurityScreenClause, root.intrinio.SecurityScreenGroup);
  }
   ...
   * @module invoker/model/SecurityScreenGroup
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/SecurityScreenGroup
   * @class
   */
   ...
   * @param {module:invoker/model/SecurityScreenGroup} obj Optional instance to populate.
   * @return {module:invoker/model/SecurityScreenGroup} The populated <code>SecurityScreenGroup</code> instance.
   */
   ...
   * @member {Array.<module:invoker/model/SecurityScreenClause>} clauses
   */
  exports.prototype['clauses'] = undefined;
  /**
   * The nested groups within the group
   * @member {Array.<module:invoker/model/SecurityScreenGroup>} groups
   */
