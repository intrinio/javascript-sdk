...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.EconomicIndex = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/EconomicIndex
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/EconomicIndex
   * @class
   */
   ...
   * @param {module:invoker/model/EconomicIndex} obj Optional instance to populate.
   * @return {module:invoker/model/EconomicIndex} The populated <code>EconomicIndex</code> instance.
   */
