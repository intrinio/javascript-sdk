...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.SecurityScreenClause = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/SecurityScreenClause
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/SecurityScreenClause
   * @class
   */
   ...
   * @param {module:invoker/model/SecurityScreenClause} obj Optional instance to populate.
   * @return {module:invoker/model/SecurityScreenClause} The populated <code>SecurityScreenClause</code> instance.
   */
   ...
   * @member {module:invoker/model/SecurityScreenClause.OperatorEnum} operator
   */
