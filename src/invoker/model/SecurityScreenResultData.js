...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.SecurityScreenResultData = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/SecurityScreenResultData
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>SecurityScreenResultData</code>.
   * @alias module:invoker/model/SecurityScreenResultData
   * @class
   */
   ...
   * @param {module:invoker/model/SecurityScreenResultData} obj Optional instance to populate.
   * @return {module:invoker/model/SecurityScreenResultData} The populated <code>SecurityScreenResultData</code> instance.
   */
