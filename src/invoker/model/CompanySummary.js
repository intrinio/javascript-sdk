...
(function(root, factory) {
   ...
   * @module invoker/model/CompanySummary
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/CompanySummary
   * @class
   */
   ...
   * @param {module:invoker/model/CompanySummary} obj Optional instance to populate.
   * @return {module:invoker/model/CompanySummary} The populated <code>CompanySummary</code> instance.
   */
