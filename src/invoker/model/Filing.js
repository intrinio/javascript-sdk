...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.Filing = factory(root.intrinio.ApiClient, root.intrinio.CompanySummary);
  }
   ...
   * @alias module:invoker/model/Filing
   * @class
   */
   ...
   * @param {module:invoker/model/Filing} obj Optional instance to populate.
   * @return {module:invoker/model/Filing} The populated <code>Filing</code> instance.
   */
