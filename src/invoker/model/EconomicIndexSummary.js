...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.EconomicIndexSummary = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/EconomicIndexSummary
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/EconomicIndexSummary
   * @class
   */
   ...
   * @param {module:invoker/model/EconomicIndexSummary} obj Optional instance to populate.
   * @return {module:invoker/model/EconomicIndexSummary} The populated <code>EconomicIndexSummary</code> instance.
   */
