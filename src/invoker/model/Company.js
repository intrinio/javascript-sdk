...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.Company = factory(root.intrinio.ApiClient);
  }
   ...
   * @alias module:invoker/model/Company
   * @class
   */
   ...
   * @param {module:invoker/model/Company} obj Optional instance to populate.
   * @return {module:invoker/model/Company} The populated <code>Company</code> instance.
   */
