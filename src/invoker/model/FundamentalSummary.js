...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.FundamentalSummary = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/FundamentalSummary
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>FundamentalSummary</code>.
   * @alias module:invoker/model/FundamentalSummary
   * @class
   */
   ...
   * @param {module:invoker/model/FundamentalSummary} obj Optional instance to populate.
   * @return {module:invoker/model/FundamentalSummary} The populated <code>FundamentalSummary</code> instance.
   */
   ...
   * @member {module:invoker/model/FundamentalSummary.TypeEnum} type
   */
