...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.StandardizedTag = factory(root.intrinio.ApiClient);
  }
  ...
  /**
   * The StandardizedTag model module.
   * @module invoker/model/StandardizedTag
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>StandardizedTag</code>.
   * @alias module:invoker/model/StandardizedTag
   * @class
   */
  ...
  /**
   * Constructs a <code>StandardizedTag</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:invoker/model/StandardizedTag} obj Optional instance to populate.
   * @return {module:invoker/model/StandardizedTag} The populated <code>StandardizedTag</code> instance.
   */
   ...
   * @member {module:invoker/model/StandardizedTag.StatementTypeEnum} statement_type
   */
