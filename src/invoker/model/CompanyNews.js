...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinio.CompanyNews = factory(root.intrinio.ApiClient);
  }
   ...
   * @module invoker/model/CompanyNews
   * @version 0.0.1
   */
   ...
   * @alias module:invoker/model/CompanyNews
   * @class
   */
   ...
   * @param {module:invoker/model/CompanyNews} obj Optional instance to populate.
   * @return {module:invoker/model/CompanyNews} The populated <code>CompanyNews</code> instance.
   */
