...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/Company', 'invoker/model/CompanyNews', 'invoker/model/CompanySummary', 'invoker/model/DataPointNumber', 'invoker/model/DataPointText', 'invoker/model/FilingSummary', 'invoker/model/Fundamental', 'invoker/model/HistoricalData'], factory);
  ...
  /**
   * Company service.
   * @module invoker/api/CompanyApi
   * @version 0.0.1
   */

  /**
   * Constructs a new CompanyApi. 
   * @alias module:invoker/api/CompanyApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:invoker/model/CompanySummary>} and HTTP response
     */
     ...
     * @param {String} opts.industryGroup Industry group
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:invoker/model/CompanySummary>}
     */
     ...
     * @param {module:invoker/model/String} opts.statementCode Only of the given statement code
     * @param {module:invoker/model/String} opts.type Only of the given type
     * @param {Date} opts.startDate Only on or after the given date
     * @param {Date} opts.endDate Only on or after the given date
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:invoker/model/Fundamental>} and HTTP response
     */
     ...
     * @param {Date} opts.endDate Only on or after the given date
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:invoker/model/Fundamental>}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:invoker/model/FilingSummary>} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:invoker/model/FilingSummary>}
     */
     ...
     * Get a Company by ID
     * @param {String} identifier A Company identifier (Ticker, CIK, LEI, Intrinio ID)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:invoker/model/Company} and HTTP response
     */
     ...
     * Get a Company by ID
     * @param {String} identifier A Company identifier (Ticker, CIK, LEI, Intrinio ID)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:invoker/model/Company}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:invoker/model/CompanyNews>} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.nextPage Gets the next page of data from a previous API call
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:invoker/model/CompanyNews>}
     */
     ...
     * @param {String} identifier A Company identifier (Ticker, CIK, LEI, Intrinio ID)
     * @param {module:invoker/model/String} statementCode The statement code
     * @param {module:invoker/model/String} fiscalPeriod The fiscal period
