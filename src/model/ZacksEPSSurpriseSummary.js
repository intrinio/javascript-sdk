...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinioSDK.ZacksEPSSurpriseSummary = factory(root.intrinioSDK.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ZacksEPSSurpriseSummary</code>.
   ...
   * @alias module:model/ZacksEPSSurpriseSummary
   * @class
   */
  ...
  /**
   * Constructs a <code>ZacksEPSSurpriseSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ZacksEPSSurpriseSummary} obj Optional instance to populate.
   * @return {module:model/ZacksEPSSurpriseSummary} The populated <code>ZacksEPSSurpriseSummary</code> instance.
   */
