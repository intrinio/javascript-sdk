...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>ApiResponseCompanyRecognize</code>.
   * @alias module:model/ApiResponseCompanyRecognize
   * @class
   */
  ...
  /**
   * Constructs a <code>ApiResponseCompanyRecognize</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiResponseCompanyRecognize} obj Optional instance to populate.
   * @return {module:model/ApiResponseCompanyRecognize} The populated <code>ApiResponseCompanyRecognize</code> instance.
   */
