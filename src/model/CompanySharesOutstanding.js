...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('adj_shares_outstanding')) {
        obj['adj_shares_outstanding'] = ApiClient.convertToType(data['adj_shares_outstanding'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} adj_shares_outstanding
   */
  exports.prototype['adj_shares_outstanding'] = undefined;
