...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinioSDK.OptionSyntheticGreeksRealtime = factory(root.intrinioSDK.ApiClient);
  }
  ...
  /**
   * The OptionSyntheticGreeksRealtime model module.
   * @module model/OptionSyntheticGreeksRealtime
   * @version 7.0.0
   */

  /**
   * Constructs a new <code>OptionSyntheticGreeksRealtime</code>.
   * Realtime stats such as greeks and implied volatility for a specific options contract.
   * @alias module:model/OptionSyntheticGreeksRealtime
   * @class
   */
  ...
  /**
   * Constructs a <code>OptionSyntheticGreeksRealtime</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OptionSyntheticGreeksRealtime} obj Optional instance to populate.
   * @return {module:model/OptionSyntheticGreeksRealtime} The populated <code>OptionSyntheticGreeksRealtime</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('synthetic_price')) {
        obj['synthetic_price'] = ApiClient.convertToType(data['synthetic_price'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} synthetic_price
   */
  exports.prototype['synthetic_price'] = undefined;
