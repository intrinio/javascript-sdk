...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinioSDK.IndexInterval = factory(root.intrinioSDK.ApiClient);
  }
  ...
  /**
   * The IndexInterval model module.
   * @module model/IndexInterval
   * @version 6.44.0
   */

  /**
   * Constructs a new <code>IndexInterval</code>.
   * Open, close, high, low, volume, average price, and change ratio for a particular interval
   * @alias module:model/IndexInterval
   * @class
   */
  ...
  /**
   * Constructs a <code>IndexInterval</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IndexInterval} obj Optional instance to populate.
   * @return {module:model/IndexInterval} The populated <code>IndexInterval</code> instance.
   */
   ...
   * @member {module:model/IndexInterval.IntervalEnum} interval
   */
