...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('bid_time')) {
        obj['bid_time'] = ApiClient.convertToType(data['bid_time'], 'Date');
      }
      ...
      if (data.hasOwnProperty('ask_time')) {
        obj['ask_time'] = ApiClient.convertToType(data['ask_time'], 'Date');
      }
      ...
      if (data.hasOwnProperty('eod_close_price')) {
        obj['eod_close_price'] = ApiClient.convertToType(data['eod_close_price'], 'Number');
      }
      if (data.hasOwnProperty('eod_close_date')) {
        obj['eod_close_date'] = ApiClient.convertToType(data['eod_close_date'], 'Date');
      }
      if (data.hasOwnProperty('normal_market_hours_last_time')) {
        obj['normal_market_hours_last_time'] = ApiClient.convertToType(data['normal_market_hours_last_time'], 'Date');
      }
      if (data.hasOwnProperty('normal_market_hours_last_price')) {
        obj['normal_market_hours_last_price'] = ApiClient.convertToType(data['normal_market_hours_last_price'], 'Number');
      }
      if (data.hasOwnProperty('normal_market_hours_last_size')) {
        obj['normal_market_hours_last_size'] = ApiClient.convertToType(data['normal_market_hours_last_size'], 'Number');
      }
      if (data.hasOwnProperty('qualified_last_price')) {
        obj['qualified_last_price'] = ApiClient.convertToType(data['qualified_last_price'], 'Number');
      }
      if (data.hasOwnProperty('qualified_last_time')) {
        obj['qualified_last_time'] = ApiClient.convertToType(data['qualified_last_time'], 'Date');
      }
      if (data.hasOwnProperty('qualified_last_size')) {
        obj['qualified_last_size'] = ApiClient.convertToType(data['qualified_last_size'], 'Number');
      }
   ...
   * @member {Date} bid_time
   */
  exports.prototype['bid_time'] = undefined;
  /**
   ...
   * @member {Date} ask_time
   */
  exports.prototype['ask_time'] = undefined;
  /**
   ...
   * @member {Number} eod_close_price
   */
  exports.prototype['eod_close_price'] = undefined;
  /**
   * The date of the previous trading session's closing price.
   * @member {Date} eod_close_date
   */
  exports.prototype['eod_close_date'] = undefined;
  /**
   ...
   * @member {Date} normal_market_hours_last_time
   */
  exports.prototype['normal_market_hours_last_time'] = undefined;
  /**
   ...
   * @member {Number} normal_market_hours_last_price
   */
  exports.prototype['normal_market_hours_last_price'] = undefined;
  /**
   ...
   * @member {Number} normal_market_hours_last_size
   */
  exports.prototype['normal_market_hours_last_size'] = undefined;
  /**
   * The price of the last trade that qualifies for last price consideration according to exchange rules on trade conditions.
   * @member {Number} qualified_last_price
   */
  exports.prototype['qualified_last_price'] = undefined;
  /**
   ...
   * @member {Date} qualified_last_time
   */
  exports.prototype['qualified_last_time'] = undefined;
  /**
   * The size of the last trade that qualifies for last price consideration according to exchange rules on trade conditions.
   * @member {Number} qualified_last_size
   */
  exports.prototype['qualified_last_size'] = undefined;
  /**
