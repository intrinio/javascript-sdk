...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinioSDK.ZacksSalesSurpriseSummary = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.SecuritySummary);
  }
  ...
  /**
   * The ZacksSalesSurpriseSummary model module.
   * @module model/ZacksSalesSurpriseSummary
   * @version 6.44.0
   */

  /**
   * Constructs a new <code>ZacksSalesSurpriseSummary</code>.
   ...
   * @alias module:model/ZacksSalesSurpriseSummary
   * @class
   */
  ...
  /**
   * Constructs a <code>ZacksSalesSurpriseSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ZacksSalesSurpriseSummary} obj Optional instance to populate.
   * @return {module:model/ZacksSalesSurpriseSummary} The populated <code>ZacksSalesSurpriseSummary</code> instance.
   */
