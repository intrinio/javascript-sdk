...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intrinioSDK.ESGRatingWithCompany = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.ESGCompanySummary);
  }
  ...
  /**
   * Constructs a new <code>ESGRatingWithCompany</code>.
   * @alias module:model/ESGRatingWithCompany
   * @class
   */
  ...
  /**
   * Constructs a <code>ESGRatingWithCompany</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ESGRatingWithCompany} obj Optional instance to populate.
   * @return {module:model/ESGRatingWithCompany} The populated <code>ESGRatingWithCompany</code> instance.
   */
