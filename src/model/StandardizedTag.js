...
(function(root, factory) {
   ...
   * @module model/StandardizedTag
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>StandardizedTag</code>.
   * @alias module:model/StandardizedTag
   * @class
   */
   ...
   * @param {module:model/StandardizedTag} obj Optional instance to populate.
   * @return {module:model/StandardizedTag} The populated <code>StandardizedTag</code> instance.
   */
   ...
   * @member {module:model/StandardizedTag.StatementTypeEnum} statement_type
   */
