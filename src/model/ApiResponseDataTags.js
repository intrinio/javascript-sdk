...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data_tags')) {
        obj['data_tags'] = ApiClient.convertToType(data['data_tags'], [DataTag]);
      }
  ...
  /**
   * @member {Array.<module:model/DataTag>} data_tags
   */
  exports.prototype['data_tags'] = undefined;
  /**
