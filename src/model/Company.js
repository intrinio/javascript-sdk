...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('first_fundamental_date')) {
        obj['first_fundamental_date'] = ApiClient.convertToType(data['first_fundamental_date'], 'Date');
      }
      if (data.hasOwnProperty('last_fundamental_date')) {
        obj['last_fundamental_date'] = ApiClient.convertToType(data['last_fundamental_date'], 'Date');
      }
   ...
   * @member {Date} first_fundamental_date
   */
  exports.prototype['first_fundamental_date'] = undefined;
  /**
   * The period end date of the company's last reported fundamental
   * @member {Date} last_fundamental_date
   */
  exports.prototype['last_fundamental_date'] = undefined;
  /**
