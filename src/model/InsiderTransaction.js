...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deemed_execution_date')) {
        obj['deemed_execution_date'] = ApiClient.convertToType(data['deemed_execution_date'], 'Date');
      }
      ...
      if (data.hasOwnProperty('exercise_date')) {
        obj['exercise_date'] = ApiClient.convertToType(data['exercise_date'], 'Date');
      }
   ...
   * @member {Date} deemed_execution_date
   */
  exports.prototype['deemed_execution_date'] = undefined;
  /**
   ...
   * @member {Date} exercise_date
   */
  exports.prototype['exercise_date'] = undefined;
  /**
