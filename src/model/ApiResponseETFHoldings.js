...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>ApiResponseETFHoldings</code>.
   * @alias module:model/ApiResponseETFHoldings
   * @class
   */
  ...
  /**
   * Constructs a <code>ApiResponseETFHoldings</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiResponseETFHoldings} obj Optional instance to populate.
   * @return {module:model/ApiResponseETFHoldings} The populated <code>ApiResponseETFHoldings</code> instance.
   */
