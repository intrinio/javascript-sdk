...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AverageTrueRangeTechnicalValue', 'model/CryptoExchangeSummary', 'model/CryptoPairSummary', 'model/TechnicalIndicator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AverageTrueRangeTechnicalValue'), require('./CryptoExchangeSummary'), require('./CryptoPairSummary'), require('./TechnicalIndicator'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ApiResponseCryptoAverageTrueRange = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.AverageTrueRangeTechnicalValue, root.intrinioSDK.CryptoExchangeSummary, root.intrinioSDK.CryptoPairSummary, root.intrinioSDK.TechnicalIndicator);
  }
}(this, function(ApiClient, AverageTrueRangeTechnicalValue, CryptoExchangeSummary, CryptoPairSummary, TechnicalIndicator) {
  'use strict';
  ...
  /**
   * Constructs a new <code>ApiResponseCryptoAverageTrueRange</code>.
   * The Average True Range calculations for the prices of a Crypto Currency Pair
   * @alias module:model/ApiResponseCryptoAverageTrueRange
   * @class
   */
  ...
  /**
   * Constructs a <code>ApiResponseCryptoAverageTrueRange</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiResponseCryptoAverageTrueRange} obj Optional instance to populate.
   * @return {module:model/ApiResponseCryptoAverageTrueRange} The populated <code>ApiResponseCryptoAverageTrueRange</code> instance.
   */
