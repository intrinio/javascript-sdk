...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CryptoExchangeSummary', 'model/CryptoPairSummary', 'model/EaseOfMovementTechnicalValue', 'model/TechnicalIndicator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CryptoExchangeSummary'), require('./CryptoPairSummary'), require('./EaseOfMovementTechnicalValue'), require('./TechnicalIndicator'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.ApiResponseCryptoEaseOfMovement = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.CryptoExchangeSummary, root.intrinioSDK.CryptoPairSummary, root.intrinioSDK.EaseOfMovementTechnicalValue, root.intrinioSDK.TechnicalIndicator);
  }
}(this, function(ApiClient, CryptoExchangeSummary, CryptoPairSummary, EaseOfMovementTechnicalValue, TechnicalIndicator) {
  'use strict';
  ...
  /**
   * Constructs a new <code>ApiResponseCryptoEaseOfMovement</code>.
   * The Ease of Movement calculations for the prices of a Crypto Currency Pair
   * @alias module:model/ApiResponseCryptoEaseOfMovement
   * @class
   */
  ...
  /**
   * Constructs a <code>ApiResponseCryptoEaseOfMovement</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiResponseCryptoEaseOfMovement} obj Optional instance to populate.
   * @return {module:model/ApiResponseCryptoEaseOfMovement} The populated <code>ApiResponseCryptoEaseOfMovement</code> instance.
   */
