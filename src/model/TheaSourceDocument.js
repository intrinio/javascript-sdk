...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TheaSourceDocumentTags'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TheaSourceDocumentTags'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.TheaSourceDocument = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.TheaSourceDocumentTags);
  }
}(this, function(ApiClient, TheaSourceDocumentTags) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tags')) {
        obj['tags'] = ApiClient.convertToType(data['tags'], [TheaSourceDocumentTags]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/TheaSourceDocumentTags>} tags
   */
