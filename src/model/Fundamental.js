...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('standardized_signature')) {
        obj['standardized_signature'] = ApiClient.convertToType(data['standardized_signature'], 'String');
      }
      if (data.hasOwnProperty('reported_signature')) {
        obj['reported_signature'] = ApiClient.convertToType(data['reported_signature'], 'String');
      }
   ...
   * @member {String} standardized_signature
   */
  exports.prototype['standardized_signature'] = undefined;
  /**
   ...
   * @member {String} reported_signature
   */
  exports.prototype['reported_signature'] = undefined;
  /**
