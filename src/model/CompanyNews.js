...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanySummary', 'model/NewsTopic', 'model/SecuritySummary'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanySummary'), require('./NewsTopic'), require('./SecuritySummary'));
  } else {
    // Browser globals (root is window)
    if (!root.intrinioSDK) {
      root.intrinioSDK = {};
    }
    root.intrinioSDK.CompanyNews = factory(root.intrinioSDK.ApiClient, root.intrinioSDK.CompanySummary, root.intrinioSDK.NewsTopic, root.intrinioSDK.SecuritySummary);
  }
}(this, function(ApiClient, CompanySummary, NewsTopic, SecuritySummary) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('issuer_company')) {
        obj['issuer_company'] = CompanySummary.constructFromObject(data['issuer_company']);
      }
      if (data.hasOwnProperty('issuer_security')) {
        obj['issuer_security'] = SecuritySummary.constructFromObject(data['issuer_security']);
      }
    }
    return obj;
  }
  ...
  /**
   * The news source.
   * @member {module:model/CompanyNews.SourceEnum} source
   */
  ...
  /**
   * The news sentiment.
   * @member {module:model/CompanyNews.ArticleSentimentEnum} article_sentiment
   */
   ...
   * @member {module:model/CompanySummary} issuer_company
   */
  exports.prototype['issuer_company'] = undefined;
  /**
   * The security that issued the story.
   * @member {module:model/SecuritySummary} issuer_security
   */
  exports.prototype['issuer_security'] = undefined;
